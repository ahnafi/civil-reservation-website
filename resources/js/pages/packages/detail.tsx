...
const howItWorks: {
    ...
    },
    {
        ...
        title: "Pengujian",
        description:
            "Tim laboratorium kami akan melakukan semua pengujian yang termasuk dalam paket menggunakan peralatan kalibrasi terbaru.",
    },
    {
        id: 4,
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-12">
                            <div className="flex flex-col gap-4 rounded-lg bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 p-6 border border-blue-100 dark:border-blue-800">
                                <div className="flex flex-col items-start justify-between gap-4 sm:items-center md:flex-row">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-white">{data.name}</h1>
                        ...
                        <div className="lg:col-span-4">
                            <div className="space-y-6">
                                            ...
                                            <Carousel className="w-full">
                                                <CarouselContent className="-ml-2 md:-ml-4">
                                                    {data.images.map((image: string, index: number) => (
                                                        <CarouselItem className="pl-2 md:pl-4 basis-1/3" key={index}>
                                                            <div
                                ...
                                <Card className="border-0 shadow-lg bg-white dark:bg-zinc-900 p-6">
                            ...
                            <div className="space-y-6">
                                <Tabs defaultValue="details" className="w-full">
                                    <TabsList className="grid w-full grid-cols-3 bg-zinc-100 dark:bg-zinc-900">
                                        <TabsTrigger
                                            className="text-xs md:text-sm data-[state=active]:bg-white dark:data-[state=active]:bg-zinc-700 data-[state=active]:text-zinc-900 dark:data-[state=active]:text-white"
                                            value="details"
                                        >
                                            Deskripsi
                                        </TabsTrigger>
                                            ...
                                            <CardContent className="p-0 mt-6">
                                                <div className="space-y-4">
                                                    {data.tests?.map((test, index: number) => (
                                                        <div
                                                            key={index}
                                                            className="rounded-lg border border-zinc-200 dark:border-zinc-700 p-4 bg-zinc-50 dark:bg-zinc-900/50"
                                                        >
                                                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                                                ...
                                                                <div className="flex items-center gap-4">
                                                                    <div className="text-right">
                                                                        <div className="text-zinc-500 dark:text-zinc-400 text-sm">Harga Individual</div>
                                                ...
                                                <div className="space-y-6">
                                                    {howItWorks.map((step) => (
                                                        <div key={step.id} className="flex gap-4">
                                                            <div className="bg-blue-600 dark:bg-blue-500 text-white flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full font-bold">
                                                                {step.id}
                                                            </div>
                                                            <div>
                                                                <p className="text-lg font-semibold text-zinc-900 dark:text-white mb-2">{step.title}</p>
                                                                <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed">{step.description}</p>
                                                            </div>
                                                        </div>
                                                    ))}
                                                </div>
