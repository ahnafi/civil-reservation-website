...
export const externalSubmissionColumns: ColumnDef<ExternalSubmission>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="flex w-[5rem] justify-center text-center capitalize">{row.getValue("code")}</div>
        ),
    },
    {
...
export const internalSubmissionColumns: ColumnDef<InternalSubmission>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => (
            ...
            <span
                className="block overflow-hidden text-ellipsis line-clamp-2"
                title={row.getValue("research_title") as string}
            >
            ...
            return (
                <div className="flex justify-center">
                    {invoices && invoices.length > 0 ? (
                        <Button onClick={handleDownloadAll} className="cursor-pointer gap-1 text-xs px-2 py-1 h-auto" size="sm">
                            <Download size={12} />
...
export const testingColumns: ColumnDef<Testing>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="flex w-[7rem] justify-center text-center capitalize">{row.getValue("code")}</div>
        ),
    },
    {
