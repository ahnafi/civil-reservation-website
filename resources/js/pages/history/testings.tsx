                ...
                <div className="flex h-full flex-1 flex-col gap-6 overflow-hidden p-6">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                        <div className="testing col-span-full space-y-2">
                            ...
                            <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
                                ...
                                <Card className="border-l-4 border-l-yellow-500 bg-white dark:bg-zinc-900">
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                                        <CardTitle className="text-base font-medium text-gray-600 dark:text-gray-400">Menunggu Pengujian</CardTitle>
                                        <Clock className="h-4 w-4 text-yellow-500" />
                                    </CardHeader>
                                    <CardContent>
                                        <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{statusCounts.waiting}</div>
                                ...
                                <Card className="border-l-4 border-l-blue-500 bg-white dark:bg-zinc-900">
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                                        <CardTitle className="text-base font-medium text-gray-600 dark:text-gray-400">Memproses Hasil</CardTitle>
                            ...
                            <div className="testing-table-filters small-font-size mb-4 hidden justify-end gap-4 rounded-lg border border-gray-200 bg-gray-50 p-4 lg:mb-6 lg:flex lg:flex-wrap dark:border-zinc-800 dark:bg-zinc-900/50">
                            ...
                            <div className="testing-table-main rounded-lg border border-gray-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                                <div className="testing-table-option mb-4 flex justify-between border-b border-zinc-200 p-4 lg:mb-6 dark:border-zinc-800">
