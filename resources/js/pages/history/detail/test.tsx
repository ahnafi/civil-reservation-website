                            ...
                            <CardContent className="bg-white p-4 dark:bg-zinc-900">
                                ...
                                <div className="rounded-lg border p-4">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative pl-8">
                                            <div
                                                className={`absolute top-1.5 left-0 h-4 w-4 rounded-full ${
                                                    ['testing', 'completed'].includes(testRecord.status) ? 'bg-green-500' : 'bg-gray-300'
                                                }`}
                                            ></div>
                                            <div className="absolute top-5 left-2 h-full w-0.5 bg-gray-200 dark:bg-gray-700"></div>
                                        ...
                                        <div className="relative pl-8">
                                            <div
                                                className={`absolute top-1.5 left-0 h-4 w-4 rounded-full ${
                                                    testRecord.status === 'completed' ? 'bg-green-500' : 'bg-gray-300'
                                                }`}
                                            ></div>
                                    ...
                                    <div className="h-2 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
                                        <div
                                            className={`h-full rounded-full transition-all duration-300 ${
                                                testRecord.status === 'cancelled' ? 'bg-red-500' : 'bg-blue-600'
                                            }`}
