...
const getPaymentMethods = (paymentType: string) => {
    const allMethods = [
        {
            id: "BANK_JATENG",
            name: "BANK JATENG",
        ...
        return [
            {
                id: "BANK_BNI_SIPIL",
                name: "BANK BNI SIPIL",
                accountNumber: "0574059529",
                accountName: "Ghiffara Hasna Royanisa",
            },
        ]
    }
...
const getPaymentMethodLogos = (methodName: string) => {
    const logoMap: { [key: string]: string } = {
        "BANK JATENG": "/img/logos/Bank Jateng_logo.png",
        "BANK MANDIRI": "/img/logos/Bank Mandiri_logo.png",
        "BANK BNI": "/img/logos/BNI_logo.png",
        "BANK BRI": "/img/logos/BRI_logo.png",
        "BANK BSI": "/img/logos/BSI_logo.png",
        "BANK BTN": "/img/logos/BTN_logo.png",
        "BANK BNI SIPIL": "/img/logos/BNI_logo.png",
    }
    return logoMap[methodName] || "/placeholder.svg"
}
...
const bankGuides = [
    {
        name: "Bank Jateng",
        logo: "/img/logos/Bank Jateng_logo.png",
        file: "/storage/payment_guides/Bank Jateng_Guide.pdf",
    },
    {
        name: "Bank Mandiri",
        logo: "/img/logos/Bank Mandiri_logo.png",
        file: "/storage/payment_guides/Bank Mandiri_Guide.pdf",
    },
    { name: "Bank BNI", logo: "/img/logos/BNI_logo.png", file: "/storage/payment_guides/BNI_Guide.pdf" },
    { name: "Bank BRI", logo: "/img/logos/BRI_logo.png", file: "/storage/payment_guides/BRI_Guide.pdf" },
    { name: "Bank BSI", logo: "/img/logos/BSI_logo.png", file: "/storage/payment_guides/BSI_Guide.pdf" },
    { name: "Bank BTN", logo: "/img/logos/BTN_logo.png", file: "/storage/payment_guides/BTN_Guide.pdf" },
]
...
export default function Payment({ transactionDetail }: { transactionDetail: Transaction[] }) {
    ...
    const handleDownload = (fileName: string) => {
        const link = document.createElement("a")
        link.href = fileName
        link.download = fileName.split("/").pop() || "guide.pdf"
        document.body.appendChild(link)
        link.click()
        document.body.removeChild(link)
    }
                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="mb-12">
                        <div className="mx-auto max-w-4xl text-center">
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-300">
                                Selamat! Pengajuan <span className="font-semibold text-blue-600">{transaction.submission_code}</span>{" "}
                                telah disetujui. Silakan lakukan pembayaran untuk melanjutkan proses pengujian.
                            </p>
                        </div>
                    </div>
                                    ...
                                    <CardContent className="space-y-4 pb-4">
                                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div
                                                    className={`font-semibold ${isOverdue ? "text-red-600" : "text-gray-900 dark:text-white"}`}
                                                >
                                ...
                                <Card className="border-0 bg-white shadow-sm dark:bg-zinc-900">
                                    ...
                                    <CardContent className="space-y-4 pb-4">
                                        ...
                                        <ol className="ml-2 list-inside list-decimal space-y-3 text-sm">
                                            ...
                                            <li className="text-gray-700 dark:text-gray-300">
                                                Unggah bukti pembayaran pada form yang disediakan
                                            </li>
                                            <li className="text-gray-700 dark:text-gray-300">
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem className="space-y-4">
                                                            <FormControl>
                                                                ...
                                                                >
                                                                    {getPaymentMethods(transaction.payment_type).map((method) => (
                                                                        <div key={method.id} className="relative">
                                                                            <RadioGroupItem value={method.name} id={method.id} className="peer sr-only" />
                                                                            <Label
                                                                                htmlFor={method.id}
                                                                            ...
                                                                            >
                                                                                <div className="flex items-center gap-3">
                                                                                    <img
                                                                                        src={getPaymentMethodLogos(method.name) || "/placeholder.svg"}
                                                                    ...
                                                                    {!imagePreview ? (
                                                                        <div className="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-8 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700">
                                                                            ...
                                                                            <Label htmlFor="payment-proof" className="cursor-pointer text-center">
                                                                                ...
                                                                                <p className="mt-1 text-xs text-gray-400">JPG, PNG, atau JPEG (Maks. 5MB)</p>
                                                                            </Label>
                                                                        </div>
                                                                    ) : (
                                        ...
                                        <div className="flex flex-col justify-between gap-4 pt-4 sm:flex-row">
                                            <Link href={`/history/submission/${transaction.submission_code}`}>
                                                <Button
                                                    ...
                                                    variant="outline"
                                                    disabled={processing}
                                                    className="h-12 w-full px-6 sm:w-auto bg-transparent"
                                                >
                            ...
                            <div className="xl:col-span-1">
                                <div className="space-y-6 xl:sticky xl:top-6">
                                    ...
                                    <Card className="border-0 shadow-sm dark:bg-zinc-900">
                                        ...
                                        <CardContent className="pb-4">
                                            {transaction.payment_type === "main" ? (
                                                <div className="space-y-2">
                                                    {bankGuides.map((bank, index) => (
                                                        <div key={index} className="flex items-center justify-between py-2">
                                                            ...
                                                            <Button
                                                                variant="outline"
                                                                size="sm"
                                                                onClick={() => handleDownload(bank.file)}
                                                ...
                                                <div className="space-y-2">
                                                    <p className="text-sm text-gray-600 dark:text-gray-300">Transfer ke:</p>
                                                    <div className="space-y-3 p-3 bg-gray-50 dark:bg-zinc-800 rounded">
                                                        <div className="flex justify-between items-center">
                                                            <div>
                                                                <p className="text-xs text-gray-500">BNI</p>
                                                                <p className="font-mono text-lg font-medium">0574059529</p>
                                                            </div>
                                                            <Button
                                                                variant="ghost"
                                                                size="sm"
                                                                onClick={() => copyToClipboard("0574059529")}
                                                                className="h-8 cursor-pointer"
                                                            >
                                                        ...
                                                        <div>
                                                            <p className="text-xs text-gray-500">a.n.</p>
                                                            <p className="text-base font-medium">Ghiffara Hasna Royanisa</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            )}
                                        ...
                                        <CardContent className="space-y-4 pb-4">
                                            <div className="space-y-3 text-sm">
                                                ...
                                                <div className="flex items-start space-x-2">
                                                    ...
                                                    <p className="text-gray-600 dark:text-gray-300">
                                                        Simpan bukti pembayaran yang jelas dan lengkap
                                                    </p>
                                                </div>
                                                <div className="flex items-start space-x-2">
                                                    <div className="mt-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30">
                                    ...
                                    <Card className="border-0 shadow-sm dark:bg-zinc-900">
                                        ...
                                        <CardContent className="space-y-4 pb-4">
                                            <div className="space-y-3 text-sm">
                                                ...
                                                <div>
                                                    <div className="font-medium text-zinc-900 dark:text-white">WhatsApp</div>
