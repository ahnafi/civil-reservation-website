                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p className="font-medium">{dummyData.status}</p>
                        </div>

                        <div>
                            <p className="text-neutral-400">Ruang</p>
                            <p className="font-medium">{dummyData.room}</p>
                        </div>

                        <div>
                            <p className="text-neutral-400">Kuota Harian</p>
                            <p className="font-medium">{dummyData.dailySlots}</p>
                        </div>

                        <div>
                            <p className="text-neutral-400">Harga</p>
                            <p className="font-medium">{formatRupiah(dummyData.price)}</p>
                        </div>
                    </div>
                </div>
