...
<head>
    <title>@section("title", "Laboratorium Sipil Unsoed")</title>
...
<body style="background-color:#edf2f7;">
    <div style="background:#fff;background-color:#fff;Margin:0px auto;max-width:600px;margin-top: 4rem;">
                                    ...
                                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width:64px;">
                                                        <img height="auto" src="{{ asset("img/logos/unsoed.png") }}"
                                    ...
                                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                        ...
                                        <div
                                            ...
                                            *Email ini dikirim secara otomatis. Mohon untuk tidak membalas email ini.
                                            <br><br>
                                            Hormat kami,<br><br> Admin Laboratorium Teknik Sipil<br>Universitas Jenderal
                                            Soedirman<br>
                                        </div>
                                    </td>
                                </tr>
                                                ...
                                                <tr>
                                                    <td align="center"
                                                        ...
                                                        <div
                                                            ...
                                                            © 2025 Teknik Sipil - Fakultas Teknik - Universitas Jenderal
                                                            Soedirman. All rights reserved.
                                                        </div>
