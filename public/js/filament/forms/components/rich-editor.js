var po = '2.1.12',
    ...
    he = function (i) {
        let { onElement: t, bubbles: e, cancelable: n, attributes: r } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
            o = t ?? pi;
        (e = e !== !1), (n = n !== !1);
    ...
    je = function (i) {
        let { onlyNodesOfType: t, usingFilter: e, expandEntityReferences: n } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
            r = (() => {
                switch (t) {
                    case 'element':
    ...
    p = function (i) {
        ...
        if ((n.editable != null && (n.attributes == null && (n.attributes = {}), (n.attributes.contenteditable = n.editable)), n.attributes))
...
`,
    ...
    Ce = Object.freeze({
        ...
        fileSize: Dr,
        input: bi,
        keyNames: { 8: 'backspace', 9: 'tab', 13: 'return', 27: 'escape', 37: 'left', 39: 'right', 46: 'delete', 68: 'd', 72: 'h', 79: 'o' },
        lang: m,
        parser: Me,
        textAttributes: Dt,
        toolbar: Fr,
    ...
    R = class {
        static proxyMethod(t) {
            ...
            this.prototype[e] = function () {
                ...
                var c, u;
                return (
                    n ? (l = o ? ((c = this[n]) === null || c === void 0 ? void 0 : c.call(this)) : this[n]()) : r && (l = this[r]),
                    o
                        ? ((s = (u = l) === null || u === void 0 ? void 0 : u[e]), s ? Xi.call(s, l, arguments) : void 0)
              ...
              return (() => {
                  ...
                  return (
                      Array.from(i).forEach((e) => {
                          let n = '';
                          e > 65535 && ((e -= 65536), (n += String.fromCharCode(((e >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
...
var So = 0,
    ...
    fe = class {
        ...
        constructor() {
            ...
            (this.objects = t),
                n && ((this.depth = e), (this.objects = this.constructor.groupObjects(this.objects, { asTree: n, depth: this.depth + 1 })));
        }
        getObjects() {
            return this.objects;
        }
...
function St(i) {
    let t = Vr(null);
    for (let [e, n] of Ur(i))
        $(i, e) && (Array.isArray(n) ? (t[e] = Wo(n)) : n && typeof n == 'object' && n.constructor === Object ? (t[e] = St(n)) : (t[e] = n));
    return t;
}
function le(i, t) {
    for (; i !== null; ) {
    ...
    Ve = (function i() {
        ...
        let Vi = function (a) {
                ...
                if (
                    ...
                    (a.hasChildNodes() && !Ui(a.firstElementChild) && _(/<[/\w]/g, a.innerHTML) && _(/<[/\w]/g, a.textContent)) ||
                        a.nodeType === Qo ||
                ...
                if (!N[h] || te[h]) {
                    if (
                        !te[h] &&
                        Hi(h) &&
                        ((w.tagNameCheck instanceof RegExp && _(w.tagNameCheck, h)) || (w.tagNameCheck instanceof Function && w.tagNameCheck(h)))
                    )
                        return !1;
                    if (vn && !_t[h]) {
                                ...
                                : v.namespaceURI === ke
                                  ? A.namespaceURI === ot
                                      ...
                                      : A.namespaceURI === Re
                                        ...
                                        : !!_i[f]
                                  : v.namespaceURI === ot
                                    ? !(A.namespaceURI === Re && !we[D]) && !(A.namespaceURI === ke && !Te[D]) && !_i[f] && (uo[f] || !Bi[f])
                                    : !(ne !== 'application/xhtml+xml' || !xn[v.namespaceURI]))
                        );
                    })(a)
                    ? (tt(a), !0)
                    : (h !== 'noscript' && h !== 'noembed' && h !== 'noframes') || !_(/<\/no(script|embed|frames)/i, a.innerHTML)
                      ? (Pt &&
                            a.nodeType === Zo &&
                            ((g = a.textContent),
                            Ne([un, hn, dn], (v) => {
                ...
                if (!(mn && !gn[g] && _(oo, g))) {
                    if (!(Ti && _(so, g))) {
                        if (!O[g] || gn[g]) {
                            ...
                            if (!_(Si, se(h, Ei, ''))) {
                                if (
                                    ((g !== 'src' && g !== 'xlink:href' && g !== 'href') || a === 'script' || _o(h, 'data:') !== 0 || !Oi[a]) &&
                                    !(wi && !_(ao, se(h, Ei, '')))
                                ) {
                                    if (h) return !1;
                                }
            ...
            (e.sanitize = function (a) {
                ...
                if ((fn || Cn(g), (e.removed = []), typeof a == 'string' && (ee = !1), ee)) {
                    ...
                    (h = ji('<!---->')),
                        ...
                        (v.nodeType === Xo && v.nodeName === 'BODY') || v.nodeName === 'HTML' ? (h = v) : h.appendChild(v);
                else {
...
var is = 'style href src width height language class'.split(' '),
    ...
    ze = class extends be {
        ...
        createContentNodes() {
            return (this.image = p({ tagName: 'img', attributes: { src: '' }, data: { trixMutable: !0 } })), this.refresh(this.image), [this.image];
        }
        createCaptionElement() {
...
function z(i, t, e) {
    return (t = hs(t)) in i ? Object.defineProperty(i, t, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : (i[t] = e), i;
}
function hs(i) {
    var t = (function (e, n) {
...
var gt = class extends ht {
    ...
    isEqualTo(t) {
        return (
            super.isEqualTo(...arguments) || (this.hasSameConstructorAs(t) && this.hasSameStringValueAsPiece(t) && this.hasSameAttributesAsPiece(t))
        );
    }
    isEmpty() {
...
var Ke = class extends Ht {
        ...
        perform(t) {
            let e = new Image();
            (e.onload = () => ((e.width = this.width = e.naturalWidth), (e.height = this.height = e.naturalHeight), t(!0, e))),
                (e.onerror = () => t(!1)),
                (e.src = this.url);
        }
    },
            ...
            if (!this.attributes.isEqualTo(e))
                return (
                    ...
                    (n = this.previewDelegate) === null ||
                        ...
                        r === void 0 ||
                        r.call(n, this),
                    (o = this.delegate) === null || o === void 0 || (s = o.attachmentDidChangeAttributes) === null || s === void 0
                        ? void 0
                        : s.call(o, this)
                );
        }
        ...
        setUploadProgress(t) {
            ...
            if (this.uploadProgress !== t)
                return (
                    ...
                    (e = this.uploadProgressDelegate) === null || e === void 0 || (n = e.attachmentDidChangeUploadProgress) === null || n === void 0
                        ? void 0
                        : n.call(e, this)
                );
        }
            ...
            if (t !== this.getPreviewURL())
                return (
                    ...
                    (e = this.previewDelegate) === null ||
                        ...
                        n === void 0 ||
                        n.call(e, this),
                    (r = this.delegate) === null || r === void 0 || (o = r.attachmentDidChangePreviewURL) === null || o === void 0
                        ? void 0
                        : o.call(r, this)
                );
        }
...
var $t = class extends ht {
        ...
        getEndPosition() {
            return (
                this.endPosition == null && ((this.endPosition = 0), this.objects.forEach((t) => (this.endPosition += t.getLength()))),
                this.endPosition
            );
        }
        toString() {
    ...
    J = class extends ht {
        ...
        getAttachmentAndPositionById(t) {
            ...
            for (let r of this.pieceList.toArray()) {
                var n;
                if (((n = r.attachment) === null || n === void 0 ? void 0 : n.id) === t) return { attachment: r.attachment, position: e };
                e += r.length;
            }
    ...
    bt = class i extends ht {
        ...
        isEqualTo(t) {
            return (
                !!super.isEqualTo(t) ||
                (this.text.isEqualTo(t?.text) && It(this.attributes, t?.attributes) && Xt(this.htmlAttributes, t?.htmlAttributes))
            );
        }
        copyWithText(t) {
...
`
        ...
        moveTextFromRangeToPosition(t, e) {
            ...
            return (
                ...
                d.length === 0 ? l : ((s = new this.constructor(d)), (e += n.getLength()), l.insertDocumentAtRange(s, e))
            );
        }
        addAttributeAtRange(t, e, n) {
            ...
            return (
                this.eachBlockAtRange(e, function (r, o, s) {
                    L(t)
                        ...
                        : o[0] !== o[1] && (n = n.editObjectAtIndex(s, () => r.copyWithText(r.text.removeAttributeAtRange(t, o))));
                }),
...
`
                    ...
                    s.offset !== u.getBlockBreakPosition() && ((e = l.positionFromLocation(s)), (l = l.insertBlockBreakAtRange([e, e + 1])));
            }
    ...
    Ft = class extends R {
        ...
        createHiddenContainer() {
            return this.referenceElement
                ...
                : ((this.containerElement = p({ tagName: 'div', style: { display: 'none' } })), document.body.appendChild(this.containerElement));
        }
...
`);
            if (e === this.containerElement || this.isBlockElement(e)) {
                ...
                It(r, (n = this.currentBlock) === null || n === void 0 ? void 0 : n.attributes) ||
                    ((this.currentBlock = this.appendBlockForAttributesWithElement(r, e, o)), (this.currentBlockElement = e));
            }
        }
...
`);
        ...
        processTextNode(t) {
            ...
            var n;
            return (
                Cr(t.parentNode) || ((e = xi(e)), Gr((n = t.previousSibling) === null || n === void 0 ? void 0 : n.textContent) && (e = Ss(e))),
...
`,
        ...
        appendAttachmentWithAttributes(t, e) {
            return this.appendPiece(
                (function (n) {
                    return { attachment: n, attributes: arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, type: 'attachment' };
                })(t, e),
            );
        }
        appendPiece(t) {
        ...
        isBlockElement(t) {
            if (t?.nodeType === Node.ELEMENT_NODE && !Tt(t) && !vt(t, { matchingSelector: 'td', untilNode: this.containerElement }))
...
var Ge = class extends R {
        ...
        requestRemovalOfAttachment(t) {
            ...
            if (this.attachmentIsManaged(t))
                return (e = this.delegate) === null || e === void 0 || (n = e.attachmentManagerDidRequestRemovalOfAttachment) === null || n === void 0
                    ? void 0
                    : n.call(e, t);
        }
...
`)
    ...
    it = class extends R {
        ...
        setDocument(t) {
            ...
            if (!t.isEqualTo(this.document))
                return (
                    ...
                    this.revision++,
                    (e = this.delegate) === null || e === void 0 || (n = e.compositionDidChangeDocument) === null || n === void 0
                        ? void 0
                        : n.call(e, t)
                );
        }
        ...
        loadSnapshot(t) {
            ...
            return (
                (e = this.delegate) === null || e === void 0 || (n = e.compositionWillLoadSnapshot) === null || n === void 0 || n.call(e),
                this.setDocument(s ?? new V()),
                this.setSelection(l ?? [0, 0]),
                (r = this.delegate) === null || r === void 0 || (o = r.compositionDidLoadSnapshot) === null || o === void 0 ? void 0 : o.call(r)
            );
        }
        insertText(t) {
...
`);
        ...
        deleteInDirection(t) {
            ...
            return (
                c && ((l = this.getExpandedRangeInDirection(t, { length: o })), t === 'backward' && (e = this.getAttachmentAtRange(l))),
                e ? (this.editAttachment(e), !1) : (this.setDocument(this.document.removeTextAtRange(l)), this.setSelection(l[0]), !n && !r && void 0)
            );
        }
        moveTextFromRange(t) {
        ...
        setCurrentAttribute(t, e) {
            return L(t)
                ...
                : (this.setTextAttribute(t, e), (this.currentAttributes[t] = e), this.notifyDelegateOfCurrentAttributesChange());
        }
        ...
        removeCurrentAttribute(t) {
            return L(t)
                ...
                : (this.removeTextAttribute(t), delete this.currentAttributes[t], this.notifyDelegateOfCurrentAttributesChange());
        }
        ...
        getLocationRange(t) {
            return this.targetLocationRange ? this.targetLocationRange : this.getSelectionManager().getLocationRange(t) || y({ index: 0, offset: 0 });
        }
                ...
                (() => {
                    ...
                    return (
                        Array.from(e).forEach((o) => {
                            ...
                            (o.delegate = this),
                                r.push(
                                    (s = this.delegate) === null || s === void 0 || (l = s.compositionDidAddAttachment) === null || l === void 0
                                        ? void 0
                                        : l.call(s, o),
                                );
                        }),
        ...
        attachmentDidChangeAttributes(t) {
            ...
            return (
                this.revision++,
                (e = this.delegate) === null || e === void 0 || (n = e.compositionDidEditAttachment) === null || n === void 0 ? void 0 : n.call(e, t)
            );
        }
        attachmentDidChangePreviewURL(t) {
            ...
            return (
                this.revision++,
                (e = this.delegate) === null || e === void 0 || (n = e.compositionDidChangeAttachmentPreviewURL) === null || n === void 0
                    ? void 0
                    : n.call(e, t)
            );
        }
        editAttachment(t, e) {
            ...
            if (t !== this.editingAttachment)
                return (
                    ...
                    (n = this.delegate) === null || n === void 0 || (r = n.compositionDidStartEditingAttachment) === null || r === void 0
                        ? void 0
...
`,
        ...
        notifyDelegateOfCurrentAttributesChange() {
            var t, e;
            return (t = this.delegate) === null || t === void 0 || (e = t.compositionDidChangeCurrentAttributes) === null || e === void 0
                ? void 0
                : e.call(t, this.currentAttributes);
        }
        notifyDelegateOfInsertionAtRange(t) {
            var e, n;
            return (e = this.delegate) === null || e === void 0 || (n = e.compositionDidPerformInsertionAtRange) === null || n === void 0
                ? void 0
                : n.call(e, t);
        }
            ...
            this.findRangesOfPieces().forEach((e) => {
                e[1] - e[0] > 1 &&
                    ...
                    this.document.getCharacterAtPosition(e[1]) !==
                        `
` && ((this.document = this.document.insertBlockBreakAtRange(e[1])), e[1] < this.selectedRange[1] && this.moveSelectedRangeForward(), e[1]++, t++),
                    e[0] !== 0 &&
        ...
        updateCurrentLocationRange(t) {
            ...
            if ((t ?? (t = this.createLocationRangeFromDOMRange(me()))) && !We(t, this.currentLocationRange))
                return (
                    ...
                    (e = this.delegate) === null || e === void 0 || (n = e.locationRangeDidChange) === null || n === void 0
                        ? void 0
    ...
    tn = class extends R {
                ...
                z(
                    ...
                    zn(() => {
                        ...
                        return (
                            ...
                            S('click', { onElement: o, matchingSelector: '[data-trix-action]', withCallback: this.didClickActionButton }),
        ...
        didClickActionButton(t) {
            ...
            if (t.target.getAttribute('data-trix-action') === 'remove')
                return (e = this.delegate) === null || e === void 0 ? void 0 : e.attachmentEditorDidRequestRemovalOfAttachment(this.attachment);
        }
        didKeyDownCaption(t) {
            var e, n;
            if (Ms[t.keyCode] === 'return')
                return (
                    ...
                    (e = this.delegate) === null || e === void 0 || (n = e.attachmentEditorDidRequestDeselectingAttachment) === null || n === void 0
                        ? void 0
    ...
    en = class extends R {
        constructor(t, e) {
            super(...arguments),
                ...
                S('click', { onElement: this.element, matchingSelector: 'a[contenteditable=false]', preventDefault: !0 }),
                S('mousedown', { onElement: this.element, matchingSelector: Rt, withCallback: this.didClickAttachment }),
        ...
        didFocus(t) {
            ...
            let n = () => {
                ...
                if (!this.focused)
                    return (
                        (this.focused = !0),
                        (r = this.delegate) === null || r === void 0 || (o = r.compositionControllerDidFocus) === null || o === void 0
                            ? void 0
                            : o.call(r)
                    );
            };
        ...
        didClickAttachment(t, e) {
            ...
            return (n = this.delegate) === null || n === void 0 || (r = n.compositionControllerDidSelectAttachment) === null || r === void 0
                ? void 0
            ...
            return (
                ...
                this.canSyncDocumentView() &&
                    ...
                    (o = this.delegate) === null ||
                        ...
                        s === void 0 ||
                        s.call(o)),
                (t = this.delegate) === null || t === void 0 || (e = t.compositionControllerDidRender) === null || e === void 0 ? void 0 : e.call(t)
            );
        }
        ...
        attachmentEditorDidRequestRemovalOfAttachment(t) {
            var e, n;
            return (e = this.delegate) === null || e === void 0 || (n = e.compositionControllerDidRequestRemovalOfAttachment) === null || n === void 0
                ? void 0
                : n.call(e, t);
        }
            ...
            if (n.length) {
                let r = n[0],
                    ...
                    s = (function (l, c) {
                        let u, d;
                        return (
                            (l = Nt.box(l)), (c = Nt.box(c)).length < l.length ? ([d, u] = nr(l, c)) : ([u, d] = nr(c, l)), { added: u, removed: d }
                        );
...
`)
    ...
    Yt = class extends R {
        ...
        requestRender() {
            var t, e;
            return (t = this.delegate) === null || t === void 0 || (e = t.inputControllerDidRequestRender) === null || e === void 0
                ? void 0
                : e.call(t);
        }
        requestReparse() {
            var t, e;
            return (
                (t = this.delegate) === null || t === void 0 || (e = t.inputControllerDidRequestReparse) === null || e === void 0 || e.call(t),
                this.requestRender()
            );
        }
        attachFiles(t) {
    ...
    Y = class extends Yt {
        ...
        elementDidMutate(t) {
            ...
            return this.isComposing()
                ? (e = this.delegate) === null || e === void 0 || (n = e.inputControllerDidAllowUnhandledInput) === null || n === void 0
                    ? void 0
                    : n.call(e)
                : this.handleInput(function () {
                      return (
                          this.mutationIsSignificant(t) && (this.mutationIsExpected(t) ? this.requestRender() : this.requestReparse()), this.reset()
                      );
                  });
        }
...
` && !o;
        ...
        getPastedHTMLUsingHiddenElement(t) {
            let e = this.getSelectedRange(),
                n = { position: 'absolute', left: ''.concat(window.pageXOffset, 'px'), top: ''.concat(window.pageYOffset, 'px'), opacity: 0 },
...
z(Y, 'events', {
    ...
    dragstart(i) {
        ...
        return (
            ...
            (t = this.delegate) === null || t === void 0 || (e = t.inputControllerDidStartDrag) === null || e === void 0 ? void 0 : e.call(t)
        );
    },
    dragover(i) {
        if (this.draggedRange || this.canAcceptDataTransfer(i.dataTransfer)) {
            ...
            if (!Xt(n, this.draggingPoint))
                return (
                    ...
                    (t = this.delegate) === null || t === void 0 || (e = t.inputControllerDidReceiveDragOverPoint) === null || e === void 0
                        ? void 0
    ...
    dragend(i) {
        var t, e;
        (t = this.delegate) === null || t === void 0 || (e = t.inputControllerDidCancelDrag) === null || e === void 0 || e.call(t),
    ...
    drop(i) {
        ...
        if (((e = this.responder) === null || e === void 0 || e.setLocationRangeFromPointRange(o), n != null && n.length)) this.attachFiles(n);
    ...
    paste(i) {
        ...
        if (n) {
            ...
            var M, mt;
            let F =
                (M = t.items) === null || M === void 0 || (M = M[0]) === null || M === void 0 || (mt = M.getAsFile) === null || mt === void 0
                    ? void 0
                    : mt.call(M);
            if (F) {
                var yt, Zt, Qt;
    ...
    z(Y, 'keys', {
        ...
        tab(i) {
            ...
            (t = this.responder) !== null &&
                ...
                ((e = this.responder) === null || e === void 0 || e.increaseNestingLevel(), this.requestRender(), i.preventDefault());
        },
        left(i) {
            var t;
            if (this.selectionIsInCursorTarget())
                return i.preventDefault(), (t = this.responder) === null || t === void 0 ? void 0 : t.moveCursorInDirection('backward');
        },
        right(i) {
            var t;
            if (this.selectionIsInCursorTarget())
                return i.preventDefault(), (t = this.responder) === null || t === void 0 ? void 0 : t.moveCursorInDirection('forward');
        },
        control: {
            d(i) {
                var t;
...
`),
            ...
            tab(i) {
                ...
                (t = this.responder) !== null &&
                    ...
                    ((e = this.responder) === null || e === void 0 || e.decreaseNestingLevel(), this.requestRender(), i.preventDefault());
            },
            left(i) {
...
var zs = (i) => {
    ...
    qs = function (i) {
        ...
        {
            let t;
            if ((i.which === null ? (t = i.keyCode) : i.which !== 0 && i.charCode !== 0 && (t = i.charCode), t != null && Qr[t] !== 'escape'))
                    ...
                    ? (this.forgetPlaceholder(),
                      this.canApplyToDocument()
                          ? (this.setInputSummary({ preferDocument: !0, didInput: !1 }),
                            ...
                            (o = this.responder) === null || o === void 0 ? void 0 : o.setSelectedRange(this.range[0] + this.data.end.length))
...
var wt = class extends Yt {
    ...
    elementDidMutate() {
        return this.scheduledRender
            ? this.composing
                ? (t = this.delegate) === null || t === void 0 || (e = t.inputControllerDidAllowUnhandledInput) === null || e === void 0
                    ? void 0
                    : e.call(t)
                : void 0
            : this.reparse();
    ...
    withTargetDOMRange(t, e) {
        ...
        return (
            ...
            t ? ((n = this.responder) === null || n === void 0 ? void 0 : n.withTargetDOMRange(t, e.bind(this))) : (Ot.reset(), e.call(this))
        );
    }
    getTargetDOMRange() {
        var t, e;
...
z(wt, 'events', {
    ...
    dragstart(i) {
        ...
        (t = this.responder) !== null &&
            ...
            (this.dragging = { range: (e = this.responder) === null || e === void 0 ? void 0 : e.getSelectedRange(), point: Jn(i) }));
    },
    dragenter(i) {
    ...
    dragover(i) {
        if (this.dragging) {
            ...
            if (!Xt(e, this.dragging.point))
                return (this.dragging.point = e), (t = this.responder) === null || t === void 0 ? void 0 : t.setLocationRangeFromPointRange(e);
    ...
    z(wt, 'keys', {
        ArrowLeft() {
            ...
            if ((i = this.responder) !== null && i !== void 0 && i.shouldManageMovingCursorInDirection('backward'))
                return this.event.preventDefault(), (t = this.responder) === null || t === void 0 ? void 0 : t.moveCursorInDirection('backward');
        },
        ArrowRight() {
            var i, t;
            if ((i = this.responder) !== null && i !== void 0 && i.shouldManageMovingCursorInDirection('forward'))
                return this.event.preventDefault(), (t = this.responder) === null || t === void 0 ? void 0 : t.moveCursorInDirection('forward');
        },
        Backspace() {
            var i, t, e;
        ...
        Tab() {
            ...
            if ((i = this.responder) !== null && i !== void 0 && i.canIncreaseNestingLevel())
                return this.event.preventDefault(), (t = this.responder) === null || t === void 0 || t.increaseNestingLevel(), this.render();
        },
        'Tab+Shift'() {
            var i, t;
            if ((i = this.responder) !== null && i !== void 0 && i.canDecreaseNestingLevel())
                return this.event.preventDefault(), (t = this.responder) === null || t === void 0 || t.decreaseNestingLevel(), this.render();
        },
    }),
    z(wt, 'inputTypes', {
        deleteByComposition() {
    ...
    sn = class extends R {
        constructor(t) {
            super(t),
                ...
                S('mousedown', { onElement: this.element, matchingSelector: hi, withCallback: this.didClickActionButton }),
                S('mousedown', { onElement: this.element, matchingSelector: ui, withCallback: this.didClickAttributeButton }),
        ...
        didClickAttributeButton(t, e) {
            ...
            var o;
            return (
                this.getDialog(r) ? this.toggleDialog(r) : (o = this.delegate) === null || o === void 0 || o.toolbarDidToggleAttribute(r),
        ...
        setAttribute(t) {
            ...
            return !r.willValidate || (r.setCustomValidity(''), r.checkValidity() && this.isSafeAttribute(r))
                ? ((e = this.delegate) === null || e === void 0 || e.toolbarDidUpdateAttribute(n, r.value), this.hideDialog())
                : (r.setCustomValidity('Invalid value'), r.setAttribute('data-trix-validate', ''), r.classList.add('trix-validate'), r.focus());
        }
        isSafeAttribute(t) {
        ...
        hideDialog() {
            ...
            if (t)
                return (
                    ...
                    this.resetDialogInputs(),
                    (e = this.delegate) === null || e === void 0 ? void 0 : e.toolbarDidHideDialog(((n) => n.getAttribute('data-trix-dialog'))(t))
                );
        }
        resetDialogInputs() {
    ...
    Lt = class extends nn {
        ...
        compositionControllerDidRender() {
            this.requestedLocationRange &&
                ...
                this.renderedCompositionRevision !== this.composition.revision &&
                    (this.runEditorFilters(), this.composition.updateCurrentAttributes(), this.notifyEditorElement('render')),
                (this.renderedCompositionRevision = this.composition.revision);
        }
        ...
        locationRangeDidChange(t) {
            return (
                ...
                this.updateCurrentActions(),
                this.attachmentLocationRange && !We(this.attachmentLocationRange, t) && this.composition.stopEditingAttachment(),
        ...
        toolbarDidToggleAttribute(t) {
            if ((this.recordFormattingUndoEntry(t), this.composition.toggleCurrentAttribute(t), this.render(), !this.selectionFrozen))
                return this.editorElement.focus();
        }
        toolbarDidUpdateAttribute(t, e) {
            if ((this.recordFormattingUndoEntry(t), this.composition.setCurrentAttribute(t, e), this.render(), !this.selectionFrozen))
                return this.editorElement.focus();
        }
        toolbarDidRemoveAttribute(t) {
            if ((this.recordFormattingUndoEntry(t), this.composition.removeCurrentAttribute(t), this.render(), !this.selectionFrozen))
                return this.editorElement.focus();
        }
        ...
        canInvokeAction(t) {
            return (
                ...
                !((e = this.actions[t]) === null || e === void 0 || (e = e.test) === null || e === void 0 || !e.call(this))
            );
            var e;
        }
        invokeAction(t, e) {
        ...
        recordFormattingUndoEntry(t) {
            ...
            if (e || !ut(n)) return this.editor.recordUndoEntry('Formatting', { context: this.getUndoContext(), consolidatable: !0 });
        }
...
var an = class extends HTMLElement {
    ...
    sa = function (i) {
        ...
        if ((t = (e = document).queryCommandSupported) !== null && t !== void 0 && t.call(e, 'enableObjectResizing'))
            return document.execCommand('enableObjectResizing', !1, !1), S('mscontrolselect', { onElement: i, preventDefault: !0 });
    },
    aa = function (i) {
        var t, e;
...
var lt = new WeakMap(),
    ...
    di = class {
        constructor(t) {
            var e, n;
            Jr((e = this), (n = ce)), n.add(e), pe(this, lt, { writable: !0, value: void 0 }), (this.element = t), Ci(this, lt, t.attachInternals());
        }
        connectedCallback() {
...
var Kn = new WeakMap(),
    ...
    gi = class {
        ...
        get labels() {
            ...
            this.element.id &&
                ...
                t.push(...Array.from(this.element.ownerDocument.querySelectorAll("label[for='".concat(this.element.id, "']")) || []));
    ...
    ye = class extends HTMLElement {
        constructor() {
            super(), pe(this, P, { writable: !0, value: void 0 }), Ci(this, P, this.constructor.formAssociated ? new di(this) : new gi(this));
        }
        get trixId() {
        ...
        get toolbarElement() {
            ...
            if (this.hasAttribute('toolbar'))
                return (t = this.ownerDocument) === null || t === void 0 ? void 0 : t.getElementById(this.getAttribute('toolbar'));
            if (this.parentNode) {
        ...
        get inputElement() {
            ...
            if (this.hasAttribute('input'))
                return (t = this.ownerDocument) === null || t === void 0 ? void 0 : t.getElementById(this.getAttribute('input'));
            if (this.parentNode) {
