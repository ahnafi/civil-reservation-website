...
var Ed = (o, p, v, C) => {
    if ((p && typeof p == 'object') || typeof p == 'function')
        for (let b of Td(p)) !Ld.call(o, b) && b !== v && ss(o, b, { get: () => p[b], enumerable: !(C = Sd(p, b)) || C.enumerable });
    return o;
};
...
var We = Ke((Yo, Qo) => {
    (function (o, p) {
            ...
            return function (m, A) {
                ...
                for (var Ve = 0; Ve < J; ++Ve) {
                    ...
                    if (vt == ',') Y[Ve] = 'N';
                        ...
                        for (var Ot = (Ve && Y[Ve - 1] == '!') || (rt < J && Y[rt] == '1') ? '1' : 'N', At = Ve; At < rt; ++At) Y[At] = Ot;
                        Ve = rt - 1;
                    }
                }
                ...
                for (var ft = 0; ft < J; ++ft)
                    if (i.test(Y[ft])) {
                        ...
                        for (
                            var lt = (ft ? Y[ft - 1] : P) == 'L', qt = (ct < J ? Y[ct] : P) == 'L', pn = lt == qt ? (lt ? 'L' : 'R') : P, Sr = ft;
                            Sr < ct;
                            ++Sr
                        )
                            Y[Sr] = pn;
                ...
                return (
                    A == 'ltr' &&
                        (St[0].level == 1 && (rr = m.match(/^\s+/)) && ((St[0].from = rr[0].length), St.unshift(new f(0, 0, rr[0].length))),
                        ce(St).level == 1 && (rr = m.match(/\s+$/)) && ((ce(St).to -= rr[0].length), St.push(new f(0, J - rr[0].length, J)))),
                    A == 'rtl' ? St.reverse() : St
                );
            };
        })();
        ...
        function Ut(e) {
            var t = e.which;
            return t == null && (e.button & 1 ? (t = 1) : e.button & 2 ? (t = 3) : e.button & 4 && (t = 2)), H && e.ctrlKey && t == 1 && (t = 3), t;
        }
        var eo = (function () {
                if (s && h < 9) return !1;
                var e = _('div');
        ...
        function ei(e) {
            ...
            var n = Br ? _('span', '\u200B') : _('span', '\xA0', null, 'display: inline-block; width: 1px; margin-right: -1px');
...
`,
            ...
            (at.prototype.column = function () {
                return (
                    this.lastColumnPos < this.start &&
                        ((this.lastColumnValue = Oe(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue)),
                        (this.lastColumnPos = this.start)),
                    this.lastColumnValue - (this.lineStart ? Oe(this.string, this.lineStart, this.tabSize) : 0)
                );
            }),
            (at.prototype.indentation = function () {
                return Oe(this.string, null, this.tabSize) - (this.lineStart ? Oe(this.string, this.lineStart, this.tabSize) : 0);
            }),
        ...
        function wn(e, t, n) {
            ...
            return (
                r.iter(a, t, function (f) {
                    ro(e, f.text, u);
                    var m = u.line;
                    (f.stateAfter = m == t - 1 || m % 5 == 0 || (m >= i.viewFrom && m < i.viewTo) ? u.save() : null), u.nextLine();
                }),
        ...
        function io(e, t) {
            ...
            if (!m) {
                var _e = t.text.length - 2,
                    be;
                if (_e > 0 && u) for (var Ce = 0; Ce < u.length; ++Ce) u[Ce].to == null && (be || (be = [])).push(new ni(u[Ce].marker, null, null));
        ...
        function ka(e, t) {
            ...
            if (n)
                for (var i = void 0, a = 0; a < n.length; ++a)
                    (i = n[a]), i.marker.collapsed && (t ? i.from : i.to) == null && (!r || oo(r, i.marker) < 0) && (r = i.marker);
            return r;
        }
        function wa(e) {
            return ka(e, !0);
            ...
            if (l)
                for (var u = 0; u < l.length; ++u) {
                    ...
                    if (f.marker.collapsed) {
                        ...
                        if (
                            !((A >= 0 && P <= 0) || (A <= 0 && P >= 0)) &&
                            ((A <= 0 && (f.marker.inclusiveRight && i.inclusiveLeft ? ye(m.to, n) >= 0 : ye(m.to, n) > 0)) ||
                                (A >= 0 && (f.marker.inclusiveRight && i.inclusiveLeft ? ye(m.from, r) <= 0 : ye(m.from, r) < 0)))
                        )
                            return !0;
                    }
                }
        ...
        (Xr.prototype.lineNo = function () {
            ...
            Wt(Xr);
        function Oc(e, t, n, r) {
            (e.text = t), e.stateAfter && (e.stateAfter = null), e.styles && (e.styles = null), e.order != null && (e.order = null), xa(e), _a(e, n);
            var i = r ? r(e) : 1;
            i != e.height && jt(e, i);
        }
        function Pc(e) {
        ...
        function Ca(e, t) {
            ...
            return it(e, 'renderLine', e, t.line, r.pre), r.pre.className && (r.textClass = xe(r.pre.className, r.textClass || '')), r;
        }
        function Hc(e) {
                    ...
                    for (var P = 0; ; ) {
                        ...
                        if (J[0] == '	') {
                            ...
                            J[0] ==
                                `
`
                                ? ((ue = A.appendChild(_('span', J[0] == '\r' ? '\u240D' : '\u2424', 'cm-invalidchar'))),
                ...
                if (((e.trailingSpace = u.charCodeAt(t.length - 1) == 32), n || r || i || m || a || l)) {
                    ...
                    if (l) for (var Ce in l) l.hasOwnProperty(Ce) && Ce != 'style' && Ce != 'class' && be.setAttribute(Ce, l[Ce]);
            ...
            for (var u = i.length, f = 0, m = 1, A = '', P, J, Y = 0, ie, ue, me, ve, _e; ; ) {
                if (Y == f) {
                    ...
                    for (var be = [], Ce = void 0, Ne = 0; Ne < r.length; ++Ne) {
                        ...
                        else if (Ie.from <= f && (Ie.to == null || Ie.to > f || ($e.collapsed && Ie.to == f && Ie.from == f))) {
                            if (
                    ...
                    if (ve && (ve.from || 0) == f) {
                        if ((Ea(t, (ve.to == null ? u + 1 : ve.to) - f, ve.marker, ve.from == null), ve.to == null)) return;
                        ve.to == f && (ve = !1);
                    }
                }
                if (f >= u) break;
        ...
        function Ma(e, t, n, r) {
            for (var i = 0; i < t.changes.length; i++) {
                var a = t.changes[i];
                a == 'text' ? Qc(e, t) : a == 'gutter' ? Da(e, t, n, r) : a == 'class' ? uo(e, t) : a == 'widget' && Vc(e, t, r);
            }
            t.changes = null;
        }
        function Ln(e) {
        ...
        function Aa(e, t) {
            ...
            return n && n.line == t.line ? ((e.display.externalMeasured = null), (t.measure = n.measure), n.built) : Ca(e, t);
        }
        function Qc(e, t) {
        ...
        function uo(e, t) {
            Yc(e, t), t.line.wrapClass ? (Ln(t).className = t.line.wrapClass) : t.node != t.text && (t.node.className = '');
            ...
            if (e.options.lineNumbers || a) {
                ...
                if (
                    ...
                    for (var f = 0; f < e.display.gutterSpecs.length; ++f) {
                        ...
                        A &&
                            u.appendChild(
                                _('div', [A], 'CodeMirror-gutter-elt', 'left: ' + r.gutterLeft[m] + 'px; width: ' + r.gutterWidth[m] + 'px'),
                            );
                    }
            }
        }
        ...
        function Qr(e, t) {
            var n = k(t),
                r = po(e, n);
            r && !r.text ? (r = null) : r && r.changes && (Ma(e, r, n, bo(e)), (e.curOp.forceUpdate = !0)), r || (r = rf(e, t));
            var i = Na(r, t, n);
            ...
            for (var r, i, a, l, u, f, m = 0; m < e.length; m += 3)
                if (
                    ...
                    t < u
                        ...
                        : t < f
                          ? ((i = t - u), (a = i + 1))
                          : (m == e.length - 3 || (t == f && e[m + 3] > t)) && ((a = f - u), (i = a - 1), t >= f && (l = 'right')),
                    i != null)
                ) {
                    if (((r = e[m + 2]), u == f && n == (r.insertLeft ? 'left' : 'right') && (l = n), n == 'left' && i == 0))
                        for (; m && e[m - 2] == e[m - 3] && e[m - 1].insertLeft; ) (r = e[(m -= 3) + 2]), (l = 'left');
                    if (n == 'right' && i == f - u)
                        for (; m < e.length - 3 && e[m + 3] == e[m + 4] && !e[m + 5].insertLeft; ) (r = e[(m += 3) + 2]), (l = 'right');
                    break;
                }
        ...
        function of(e, t, n, r) {
            ...
            for (
                var Y = m.top - t.rect.top, ie = m.bottom - t.rect.top, ue = (Y + ie) / 2, me = t.view.measure.heights, ve = 0;
            ...
            return !m.left && !m.right && (Ce.bogus = !0), e.options.singleCursorHeightPerLine || ((Ce.rtop = Y), (Ce.rbottom = ie)), Ce;
        }
        function af(e, t) {
            if (!window.screen || screen.logicalXDPI == null || screen.logicalXDPI == screen.deviceXDPI || !to(e)) return t;
        ...
        function lf(e, t, n, r, i) {
            ...
            var J = null,
                ...
                ie = De(
                    function (Ne) {
                        var Ie = tr(e, a, Ne);
                        return (Ie.top += l), (Ie.bottom += l), vo(Ie, r, i, !1) ? (Ie.top <= i && Ie.left <= r && ((J = Ne), (Y = Ie)), !0) : !1;
                    },
                    u,
                    f,
                ),
            ...
            if (Y) {
                ...
                !m && (ie == f || ie == u) && ie++,
                    (me = ie == 0 ? 'after' : ie == t.text.length ? 'before' : tr(e, a, ie - (m ? 1 : 0)).bottom + l <= i == m ? 'after' : 'before');
        ...
        function bo(e) {
            for (var t = e.display, n = {}, r = {}, i = t.gutters.clientLeft, a = t.gutters.firstChild, l = 0; a; a = a.nextSibling, ++l) {
                var u = e.display.gutterSpecs[l].className;
                (n[u] = a.offsetLeft + a.clientLeft + i), (r[u] = a.clientWidth);
            }
            return { fixedPos: yo(t), gutterTotalWidth: t.gutters.offsetWidth, gutterLeft: n, gutterWidth: r, wrapperWidth: t.wrapper.clientWidth };
        }
        function yo(e) {
        ...
        function Za(e) {
            ...
            return function (i) {
                ...
                var a = 0;
                if (i.widgets) for (var l = 0; l < i.widgets.length; l++) i.widgets[l].height && (a += i.widgets[l].height);
        ...
        function zt(e, t, n, r) {
            ...
            else if (n <= i.viewFrom) or && Ta(e.doc, n + r) > i.viewFrom ? br(e) : ((i.viewFrom += r), (i.viewTo += r));
        ...
        function cf(e, t, n) {
            ...
            i.length == 0 || t >= r.viewTo || n <= r.viewFrom
                ...
                : (r.viewFrom > t ? (r.view = si(e, t, r.viewFrom).concat(r.view)) : r.viewFrom < t && (r.view = r.view.slice(Ar(e, t))),
                  (r.viewFrom = t),
                  r.viewTo < n ? (r.view = r.view.concat(si(e, r.viewTo, n))) : r.viewTo > n && (r.view = r.view.slice(0, Ar(e, n)))),
                (r.viewTo = n);
        }
        function Xa(e) {
        ...
        function en(e, t) {
            e.state.delayingBlurEvent ||
                (e.state.focused && (it(e, 'blur', e, t), (e.state.focused = !1), Q(e.display.wrapper, 'CodeMirror-focused')),
            ...
            for (
                ...
                if (!u.hidden) {
                    if (((i += u.line.height), s && h < 8)) {
                        ...
                        (m = J.bottom - J.top), !f && u.text.firstChild && (A = u.text.firstChild.getBoundingClientRect().right - J.left - 1);
                    }
                    ...
                    if (A > e.display.sizerWidth) {
                        ...
                        ue > e.display.maxLineLength &&
                            ((e.display.maxLineLength = ue), (e.display.maxLine = u.line), (e.display.maxLineChanged = !0));
                    }
                }
            }
        ...
        function Lo(e, t) {
            t != null && (mi(e), (e.curOp.scrollTop = (e.curOp.scrollTop == null ? e.doc.scrollTop : e.curOp.scrollTop) + t));
        }
        function tn(e) {
            mi(e);
            var t = e.getCursor();
        ...
        function Mn(e, t, n) {
            (t != null || n != null) && mi(e), t != null && (e.curOp.scrollLeft = t), n != null && (e.curOp.scrollTop = n);
        }
        function gf(e, t) {
        ...
        function rn(e, t) {
            ...
            for (var i = 0; (i < 4 && n != e.display.barWidth) || r != e.display.barHeight; i++)
                n != e.display.barWidth && e.options.lineWrapping && hi(e), tl(e, Dn(e)), (n = e.display.barWidth), (r = e.display.barHeight);
        }
        function tl(e, t) {
            var n = e.display,
        ...
        function nl(e) {
            e.display.scrollbars &&
                (e.display.scrollbars.clear(), e.display.scrollbars.addClass && Q(e.display.wrapper, e.display.scrollbars.addClass)),
        ...
        function bf(e) {
            ...
            Sf(t),
                ...
                (e.update = e.mustUpdate && new vi(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate));
        }
        function yf(e) {
        ...
        function xf(e) {
            ...
            e.updatedDisplay && hi(t),
                ...
                n.maxLineChanged &&
                    ...
                    (e.barMeasure.scrollWidth = Math.max(n.scroller.clientWidth, n.sizer.offsetLeft + e.adjustWidthTo + er(t) + t.display.barWidth)),
        ...
        function _f(e) {
            ...
            e.adjustWidthTo != null &&
                ...
                e.maxScrollLeft < t.doc.scrollLeft && Dr(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
        ...
        function Lf(e) {
            if (
                ...
                (e.activeElt.focus(),
                !/^(INPUT|TEXTAREA)$/.test(e.activeElt.nodeName) && e.anchorNode && I(document.body, e.anchorNode) && I(document.body, e.focusNode))
            ) {
        ...
        function Co(e, t) {
            ...
            var u = a != n.viewFrom || l != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth;
            cf(e, a, l), (n.viewOffset = ar(Ae(e.doc, n.viewFrom))), (e.display.mover.style.top = n.viewOffset + 'px');
            var f = Xa(e);
            if (!u && f == 0 && !t.force && n.renderedView == n.view && (n.updateLineNumbers == null || n.updateLineNumbers >= n.viewTo)) return !1;
            var m = Tf(e);
            return (
        ...
        function Cf(e, t, n) {
            ...
            function u(ie) {
                ...
                return g && H && e.display.currentWheelTarget == ie ? (ie.style.display = 'none') : ie.parentNode.removeChild(ie), ue;
            }
        ...
        function ol(e) {
            ...
            if (!(!t.alignWidgets && (!t.gutters.firstChild || !e.options.fixedGutter))) {
                for (var r = yo(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, a = r + 'px', l = 0; l < n.length; l++)
                    if (!n[l].hidden) {
                        e.options.fixedGutter &&
                            (n[l].gutter && (n[l].gutter.style.left = a), n[l].gutterBackground && (n[l].gutterBackground.style.left = a));
                        var u = n[l].alignable;
        ...
        function ul(e, t) {
            ...
            if ((r && f) || (i && m)) {
                ...
                if (i && a != null) {
                    ...
                    Y < 0 ? (ie = Math.max(0, ie + Y - 50)) : (ue = Math.min(e.doc.height, ue + Y + 50)), Eo(e, { top: ie, bottom: ue });
                }
                bi < 20 &&
                    t.deltaMode !== 0 &&
                    (l.wheelStartX == null
                        ? ((l.wheelStartX = u.scrollLeft),
                          ...
                          setTimeout(function () {
                              if (l.wheelStartX != null) {
                                  ...
                                  (l.wheelStartX = l.wheelStartY = null), _e && ((sr = (sr * bi + _e) / (bi + 1)), ++bi);
                              }
                          }, 200))
        ...
        (Rt.prototype.primary = function () {
            ...
            (Rt.prototype.deepCopy = function () {
                for (var e = [], t = 0; t < this.ranges.length; t++) e[t] = new Ye(pt(this.ranges[t].anchor), pt(this.ranges[t].head));
        ...
        function xr(e) {
            return e.text ? ne(e.from.line + e.text.length - 1, ce(e.text).length + (e.text.length == 1 ? e.from.ch : 0)) : e.to;
        }
        function cl(e, t) {
        ...
        function Io(e, t, n, r) {
            ...
            if (t.full) e.insert(0, l(0, m.length)), e.remove(m.length, e.size - m.length);
                ...
                if (m.length == 1) a(A, A.text.slice(0, u.ch) + J + A.text.slice(f.ch), Y);
                    ...
                    me.push(new Xr(J + A.text.slice(f.ch), Y, r)), a(A, A.text.slice(0, u.ch) + m[0], i(0)), e.insert(u.line + 1, me);
                }
            else if (m.length == 1) a(A, A.text.slice(0, u.ch) + m[0] + P.text.slice(f.ch), i(0)), e.remove(u.line + 1, ie);
            else {
            ...
            if (
                (i.lastOp == r ||
                    (i.lastOrigin == t.origin &&
                        t.origin &&
                        ((t.origin.charAt(0) == '+' && i.lastModTime > a - (e.cm ? e.cm.options.historyEventDelay : 500)) ||
                            t.origin.charAt(0) == '*'))) &&
                (l = Df(i, i.lastOp == r))
            )
                (u = ce(l.changes)), ye(t.from, t.to) == 0 && ye(t.from, u.to) == 0 ? (u.to = xr(t)) : l.changes.push(Fo(e, t));
            else {
                var f = ce(i.done);
                for (
                    (!f || !f.ranges) && xi(e.sel, i.done), l = { changes: [Fo(e, t)], generation: i.generation }, i.done.push(l);
        ...
        function If(e, t, n, r) {
            var i = e.history,
                a = r && r.origin;
            n == i.lastSelOp || (a && i.lastSelOrigin == a && ((i.lastModTime == i.lastSelTime && i.lastOrigin == a) || qf(e, a, ce(i.done), t)))
            ...
            for (var r = [], i = 0; i < e.length; ++i) {
                ...
                for (var f = 0; f < l.length; ++f) {
                    ...
                    if ((u.push({ from: m.from, to: m.to, text: m.text }), t))
                        for (var P in m) (A = P.match(/^spans_(\d+)$/)) && Se(t, Number(A[1])) > -1 && ((ce(u)[P] = m[P]), delete m[P]);
                }
            }
            return r;
        }
        ...
        function _i(e, t, n, r, i) {
            i == null && (i = e.cm && (e.cm.display.shift || e.extend)), wt(e, new Rt([No(e.sel.primary(), t, n, i)], 0), r);
        }
        function yl(e, t, n) {
        ...
        function ki(e, t, n) {
            ...
            kl(e, Sl(e, t, r, !0)), !(n && n.scroll === !1) && e.cm && e.cm.getOption('readOnly') != 'nocursor' && tn(e.cm);
        }
        function kl(e, t) {
            t.equals(e.sel) ||
                ((e.sel = t), e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), Ht(e.cm)), ht(e, 'cursorActivity', e));
        }
        function wl(e) {
        ...
        function on(e, t, n, r, i) {
            ...
            if (a.markedSpans)
                for (var l = 0; l < a.markedSpans.length; ++l) {
                    ...
                    if ((u.from == null || (m ? u.from <= t.ch : u.from < t.ch)) && (u.to == null || (A ? u.to >= t.ch : u.to > t.ch))) {
                        ...
                        return (r < 0 ? m : A) && (Y = Tl(e, Y, r, Y.line == t.line ? a : null)), Y ? on(e, Y, t, r, i) : null;
                    }
                }
            return t;
        }
        function wi(e, t, n, r, i) {
            var a = r || 1,
                l = on(e, t, n, a, i) || (!i && on(e, t, n, a, !0)) || on(e, t, n, -a, i) || (!i && on(e, t, n, -a, !0));
            ...
            return (
                n &&
                    (r.update = function (i, a, l, u) {
                        i && (r.from = Re(e, i)), a && (r.to = Re(e, a)), l && (r.text = l), u !== void 0 && (r.origin = u);
                    }),
        ...
        function an(e, t, n) {
            ...
            if (!((Ft(e, 'beforeChange') || (e.cm && Ft(e.cm, 'beforeChange'))) && ((t = Cl(e, t, !0)), !t))) {
                ...
                if (r) for (var i = r.length - 1; i >= 0; --i) El(e, { from: r[i].from, to: r[i].to, text: i ? [''] : t.text, origin: t.origin });
                else El(e, t);
            }
        }
        function El(e, t) {
        ...
        function Si(e, t, n) {
            ...
            if (!(r && !n)) {
                for (
                    var i = e.history, a, l = e.sel, u = t == 'undo' ? i.done : i.undone, f = t == 'undo' ? i.undone : i.done, m = 0;
                ...
                if (m != u.length) {
                    ...
                    var A = [];
                    xi(l, f), f.push({ changes: A, generation: i.generation }), (i.generation = a.generation || ++i.maxGeneration);
                    for (
                        var P = Ft(e, 'beforeChange') || (e.cm && Ft(e.cm, 'beforeChange')),
                            J = function (ue) {
                                ...
                                On(e, me, ve, bl(e, me)), !ue && e.cm && e.cm.scrollIntoView({ from: me.from, to: xr(me) });
                                var _e = [];
                                _r(e, function (be, Ce) {
                                    !Ce && Se(_e, be.history) == -1 && (Dl(be.history, me), _e.push(be.history)), On(be, me, null, bl(be, me));
                                });
                            },
        ...
        function On(e, t, n, r) {
            ...
            if (!(t.from.line > e.lastLine())) {
                if (t.from.line < e.first) {
                    ...
                    zl(e, i), (t = { from: ne(e.first, 0), to: ne(t.to.line + i, t.to.ch), text: [ce(t.text)], origin: t.origin });
                }
                var a = e.lastLine();
                t.to.line > a && (t = { from: t.from, to: ne(a, Ae(e, a).text.length), text: [t.text[0]], origin: t.origin }),
            ...
            e.options.lineWrapping ||
                ...
                e.options.lineWrapping ||
                    (r.iter(f, a.line + t.text.length, function (Y) {
                        var ie = li(Y);
                        ie > i.maxLineLength && ((i.maxLine = Y), (i.maxLineLength = ie), (i.maxLineChanged = !0), (u = !1));
                    }),
                    u && (e.curOp.updateMaxLine = !0)),
                Lc(r, a.line),
                In(e, 400);
            var m = t.text.length - (l.line - a.line) - 1;
            t.full ? zt(e) : a.line == l.line && t.text.length == 1 && !dl(e.doc, t) ? vr(e, a.line, 'text') : zt(e, a.line, l.line + 1, m);
            var A = Ft(e, 'changes'),
                P = Ft(e, 'change');
            if (P || A) {
        ...
        function Al(e, t, n, r) {
            for (var i = 0; i < e.length; ++i) {
                ...
                if (a.ranges) {
                    ...
                    for (var u = 0; u < a.ranges.length; u++) Ml(a.ranges[u].anchor, t, n, r), Ml(a.ranges[u].head, t, n, r);
                    continue;
                }
        ...
        function Pn(e, t, n, r) {
            var i = t,
                a = t;
            return typeof t == 'number' ? (a = Ae(e, ua(e, t))) : (i = k(t)), i == null ? null : (r(a, i) && e.cm && vr(e.cm, i, n), a);
        }
        function jn(e) {
        ...
        function jf(e, t, n, r) {
            ...
            return (
                ...
                Pn(e, t, 'widget', function (l) {
                    ...
                    if (
                        (i.insertAt == null ? u.push(i) : u.splice(Math.min(u.length, Math.max(0, i.insertAt)), 0, i), (i.line = l), a && !mr(e, l))
                    ) {
        ...
        (kr.prototype.clear = function () {
            if (!this.explicitlyCleared) {
                ...
                for (var r = null, i = null, a = 0; a < this.lines.length; ++a) {
                    ...
                    e && !this.collapsed ? vr(e, k(l), 'text') : e && (u.to != null && (i = k(l)), u.from != null && (r = k(l))),
                ...
                if (e && this.collapsed && !e.options.lineWrapping)
                    for (var f = 0; f < this.lines.length; ++f) {
                        var m = Zt(this.lines[f]),
                            A = li(m);
                        A > e.display.maxLineLength && ((e.display.maxLine = m), (e.display.maxLineLength = A), (e.display.maxLineChanged = !0));
                    }
        ...
        (Mt.prototype = oe(Rn.prototype, {
            ...
            setValue: mt(function (e) {
                ...
                an(this, { from: t, to: ne(n, Ae(this, n).text.length), text: this.splitLines(e), origin: 'setValue', full: !0 }, !0),
            ...
            setSelections: mt(function (e, t, n) {
                if (e.length) {
                    for (var r = [], i = 0; i < e.length; i++) r[i] = new Ye(Re(this, e[i].anchor), Re(this, e[i].head || e[i].anchor));
            ...
            copy: function (e) {
                var t = new Mt(kn(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
                return (
...
`
                    ...
                    if (r && r.length && window.FileReader && window.File)
                        for (
                            var i = r.length,
                                ...
                                f = function (Y, ie) {
                                    if (t.options.allowDropFileTypes && Se(t.options.allowDropFileTypes, Y.type) == -1) {
                                        u();
                                        return;
                                    }
                        ...
                        try {
                            ...
                            if (A) {
                                var P;
                                if ((t.state.draggingText && !t.state.draggingText.copy && (P = t.listSelections()), ki(t.doc, yr(n, n)), P))
        ...
        function $f(e, t) {
            ...
            if (
                ...
                (t.dataTransfer.setData('Text', e.getSelection()), (t.dataTransfer.effectAllowed = 'copyMove'), t.dataTransfer.setDragImage && !w)
            ) {
            ...
            for (var n in e)
                if (e.hasOwnProperty(n)) {
                    ...
                    for (var i = Be(n.split(' '), Yf), a = 0; a < i.length; a++) {
                        var l = void 0,
                            u = void 0;
                        a == i.length - 1 ? ((u = i.join(' ')), (l = r)) : ((u = i.slice(0, a + 1).join(' ')), (l = '...'));
                        var f = t[u];
                        if (!f) t[u] = l;
        ...
        function un(e, t, n, r) {
            ...
            if (t.fallthrough) {
                if (Object.prototype.toString.call(t.fallthrough) != '[object Array]') return un(e, t.fallthrough, n, r);
        ...
        function Vf(e, t, n, r) {
            ...
            var a = Pt(i, n.ch, n.sticky),
                l = i[a];
            if (e.doc.direction == 'ltr' && l.level % 2 == 0 && (r > 0 ? l.to > n.ch : l.from < n.ch)) return jo(t, n, r);
            var u = function (ve, _e) {
                    return Po(t, ve instanceof ne ? ve.ch : ve, _e);
                },
                f,
                m = function (ve) {
                    return e.options.lineWrapping ? ((f = f || Qr(e, t)), Ga(e, t, f, ve)) : { begin: 0, end: t.text.length };
                },
            ...
            var ie = function (ve, _e, be) {
                    for (
                        ...
                        if ((Ne.from <= $e && $e < Ne.to) || (($e = Ie ? Ne.from : u(Ne.to, -1)), be.begin <= $e && $e < be.end)) return Ce($e, Ie);
                    }
                },
                ue = ie(a + r, r, A);
            if (ue) return ue;
            var me = r > 0 ? A.end : u(A.begin, -1);
            return me != null && !(r > 0 && me == t.text.length) && ((ue = ie(r > 0 ? 0 : i.length - 1, r, m(me))), ue) ? ue : null;
        }
        var $n = {
            selectAll: Ll,
                            ...
                            if (a) {
                                if ((i.ch == a.length && (i = new ne(i.line, i.ch - 1)), i.ch > 0))
                                    (i = new ne(i.line, i.ch + 1)),
                                        e.replaceRange(a.charAt(i.ch - 1) + a.charAt(i.ch - 2), ne(i.line, i.ch - 2), i, '+transpose');
...
`,
        ...
        function Gl(e) {
            ...
            if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = B(de(t))), !ot(t, e))) {
                ...
                var r = Kl(t, e);
                d && ((Ho = r ? n : null), !r && n == 88 && !ti && (H ? e.metaKey : e.ctrlKey) && t.replaceSelection('', null, 'cut')),
                    v && !H && !r && n == 46 && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand('cut'),
        ...
        function nd(e) {
            ...
            function n(r) {
                (r.keyCode == 18 || !r.altKey) && (Q(t, 'CodeMirror-crosshair'), _t(document, 'keyup', n), _t(document, 'mouseover', n));
            }
        ...
        function cd(e, t, n, r) {
            ...
            r.addNew
                ? u == -1
                    ...
                    : m.length > 1 && m[u].empty() && r.unit == 'char' && !r.extend
                      ? (wt(a, Yt(e, m.slice(0, u).concat(m.slice(u + 1)), 0), { scroll: !1, origin: '*mouse' }), (f = a.sel))
                      : Oo(a, u, l, Je)
                ...
                if (ye(P, be) != 0)
                    if (((P = be), r.unit == 'rectangle')) {
                        ...
                        var Dt = l,
                            ...
                            ft = Dt.anchor,
                            ct;
                        ye(yt.anchor, ft) > 0 ? ((ct = yt.head), (ft = Zr(Dt.from(), yt.anchor))) : ((ct = yt.anchor), (ft = Et(Dt.to(), yt.head)));
            ...
            var ve = gt(e, function (be) {
                ...
                _e = gt(e, me);
            (e.state.selectingText = _e), Fe(i.wrapper.ownerDocument, 'mousemove', ve), Fe(i.wrapper.ownerDocument, 'mouseup', _e);
        }
        function fd(e, t) {
            var n = t.anchor,
                r = t.head,
        ...
        function pd(e) {
            ...
            (e.defineOption = n),
                ...
                n(
                    ...
                    /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b\u200e\u200f\u2028\u2029\u202d\u202e\u2066\u2067\u2069\ufeff\ufff9-\ufffc]/g,
                    function (r, i, a) {
                        (r.state.specialChars = new RegExp(i.source + (i.test('	') ? '' : '|	'), 'g')), a != fn && r.refresh();
                    },
                ),
                n(
                ...
                n(
                    ...
                    'native',
                    function (r) {
                        nl(r), rn(r), r.display.scrollbars.setScrollTop(r.doc.scrollTop), r.display.scrollbars.setScrollLeft(r.doc.scrollLeft);
                    },
                    !0,
                ),
                n(
        ...
        function gd(e) {
            e.options.lineWrapping
                ? (le(e.display.wrapper, 'CodeMirror-wrap'), (e.display.sizer.style.minWidth = ''), (e.display.sizerWidth = null))
        ...
        function tt(e, t) {
            ...
            Fr(this),
                g && t.lineWrapping && getComputedStyle(a.lineDiv).textRendering == 'optimizelegibility' && (a.lineDiv.style.textRendering = 'auto');
        }
            ...
            Fe(t.scroller, 'touchstart', function (f) {
                if (!ot(e, f) && !a(f) && !Wo(e, f)) {
                    ...
                    (t.activeTouch = { start: m, moved: !1, prev: m - r.end <= 300 ? r : null }),
                        f.touches.length == 1 && ((t.activeTouch.left = f.touches[0].pageX), (t.activeTouch.top = f.touches[0].pageY));
                }
            }),
                ...
                Fe(t.scroller, 'scroll', function () {
                    t.scroller.clientHeight && (An(e, t.scroller.scrollTop), Dr(e, t.scroller.scrollLeft, !0), it(e, 'scroll', e));
                }),
        ...
        function Xn(e, t, n, r) {
            ...
            if ((J < A && (P += G(A - J)), P != m)) return ln(i, P, ne(t, 0), ne(t, m.length), '+input'), (u.stateAfter = null), !0;
...
`) &&
                            (ie = ue = ne(ie.line, 0)));
                var me = { from: ie, to: ue, text: m ? m[J % m.length] : f, origin: i || (u ? 'paste' : e.state.cutIncoming > l ? 'cut' : '+input') };
        ...
        function os() {
            ...
            return g ? (e.style.width = '1000px') : e.setAttribute('wrap', 'off'), y && (e.style.border = '1px solid black'), t;
        }
        function vd(e) {
            var t = e.optionHandlers,
                n = (e.helpers = {});
            (e.prototype = {
                ...
                setOption: function (r, i) {
                    var a = this.options,
                        l = a[r];
                    (a[r] == i && r != 'mode') || ((a[r] = i), t.hasOwnProperty(r) && gt(this, t[r])(this, i, l), it(this, 'optionChange', this, r));
                },
                ...
                removeKeyMap: function (r) {
                    for (var i = this.state.keyMaps, a = 0; a < i.length; ++a) if (i[a] == r || i[a].name == r) return i.splice(a, 1), !0;
                },
                addOverlay: Tt(function (r, i) {
                    ...
                    te(this.state.overlays, { mode: a, modeSpec: r, opaque: i && i.opaque, priority: (i && i.priority) || 0 }, function (l) {
                        return l.priority;
                    }),
                        this.state.modeGen++,
                        zt(this);
                ...
                indentSelection: Tt(function (r) {
                    for (var i = this.doc.sel.ranges, a = -1, l = 0; l < i.length; l++) {
                        var u = i[l];
                        if (u.empty()) u.head.line > a && (Xn(this, u.head.line, r, !0), (a = u.head.line), l == this.doc.sel.primIndex && tn(this));
                        else {
                            var f = u.from(),
                                m = u.to(),
                                A = Math.max(a, f.line);
                            ...
                            f.ch == 0 && i.length == J.length && J[l].from().ch > 0 && Oo(this.doc, l, new Ye(f, J[l].to()), ke);
                        }
                    }
                }),
                ...
                cursorCoords: function (r, i) {
                    ...
                    return (
                        r == null ? (a = l.head) : typeof r == 'object' ? (a = Re(this.doc, r)) : (a = r ? l.from() : l.to()),
                        Xt(this, a, i || 'page')
                    );
                },
                ...
                lineAtHeight: function (r, i) {
                    return (r = Ua(this, { top: r, left: 0 }, i || 'page').top), O(this.doc, r + this.display.viewOffset);
                },
                heightAtLine: function (r, i, a) {
                    ...
                    return ci(this, u, { top: 0, left: 0 }, i || 'page', a || l).top + (l ? this.doc.height - ar(u) : 0);
                },
                ...
                addWidget: function (r, i, a, l, u) {
                    ...
                    (i.style.top = m + 'px'),
                        ...
                        u == 'right'
                            ...
                            : (u == 'left' ? (A = 0) : u == 'middle' && (A = (f.sizer.clientWidth - i.offsetWidth) / 2), (i.style.left = A + 'px')),
        ...
        function Go(e, t, n, r, i) {
            ...
            function m() {
                var _e = t.line + f;
                return _e < e.first || _e >= e.first + e.size ? !1 : ((t = new ne(_e, t.ch, t.sticky)), (u = Ae(e, _e)));
            }
            function A(_e) {
                var be;
                if (r == 'codepoint') {
            ...
            if (r == 'char' || r == 'codepoint') A();
                ...
                for (var P = null, J = r == 'group', Y = e.cm && e.cm.getHelper(t, 'wordChars'), ie = !0; !(n < 0 && !A(!ie)); ie = !1) {
                    var ue =
                            u.text.charAt(t.ch) ||
                            `
`,
...
`
        ...
        function as(e, t, n, r) {
            var i = e.doc,
                ...
                l;
            if (r == 'page') {
                var u = Math.min(e.display.wrapper.clientHeight, pe(e).innerHeight || i(e).documentElement.clientHeight),
        ...
        (Qe.prototype.init = function (e) {
            ...
            function l(u) {
                if (!(!a(u) || ot(r, u))) {
                    if (r.somethingSelected()) zi({ lineWise: !1, text: r.getSelections() }), u.type == 'cut' && r.replaceSelection('', null, 'cut');
...
`));
            ...
            (Qe.prototype.focus = function () {
                this.cm.options.readOnly != 'nocursor' &&
                    ((!this.selectionInEditor() || B(ze(this.div)) != this.div) && this.showSelection(this.prepareSelection(), !0), this.div.focus());
            }),
            ...
            (Qe.prototype.pollContent = function () {
                ...
                if (
                    ...
                    return !1;
                for (
                    var P = e.doc.splitLines(yd(e, u, A, l, m)), J = ir(e.doc, ne(l, 0), ne(m, Ae(e.doc, m).text.length));
                ...
                for (var Y = 0, ie = 0, ue = P[0], me = J[0], ve = Math.min(ue.length, me.length); Y < ve && ue.charCodeAt(Y) == me.charCodeAt(Y); )
                    ++Y;
                for (
                    var _e = ce(P), be = ce(J), Ce = Math.min(_e.length - (P.length == 1 ? Y : 0), be.length - (J.length == 1 ? Y : 0));
                    ie < Ce && _e.charCodeAt(_e.length - ie - 1) == be.charCodeAt(be.length - ie - 1);

                )
                    ++ie;
                if (P.length == 1 && J.length == 1 && l == r.line)
                    for (; Y && Y > r.ch && _e.charCodeAt(_e.length - ie - 1) == be.charCodeAt(be.length - ie - 1); ) Y--, ie++;
                (P[P.length - 1] = _e.slice(0, _e.length - ie).replace(/^\u200b+/, '')), (P[0] = P[0].slice(Y).replace(/\u200b+$/, ''));
                var Ne = ne(l, Y),
            ...
            (Qe.prototype.onKeyPress = function (e) {
                e.charCode == 0 ||
                    this.composing ||
                    (e.preventDefault(),
                    this.cm.isReadOnly() || gt(this.cm, $o)(this.cm, String.fromCharCode(e.charCode == null ? e.keyCode : e.charCode), 0));
            }),
...
`)),
            ...
            (st.prototype.reset = function (e) {
                if (!(this.contextMenuPending || (this.composing && e))) {
                    ...
                    if (((this.resetting = !0), t.somethingSelected())) {
                        ...
                        (this.textarea.value = n), t.state.focused && q(this.textarea), s && h >= 9 && (this.hasSelection = n);
                    } else e || ((this.prevInput = this.textarea.value = ''), s && h >= 9 && (this.hasSelection = null));
                    this.resetting = !1;
                }
            }),
            ...
            (st.prototype.poll = function () {
                ...
                if ((s && h >= 9 && this.hasSelection === i) || (H && /[\uf700-\uf7ff]/.test(i))) return t.display.input.reset(), !1;
                ...
                (f.save = r),
                    ...
                    (f.toTextArea = function () {
                        (f.toTextArea = isNaN),
                            ...
                            (e.style.display = ''),
                            e.form &&
                                (_t(e.form, 'submit', r), !t.leaveSubmitMethodAlone && typeof e.form.submit == 'function' && (e.form.submit = i));
                    });
            }),
            ...
            return {
                ...
                token: function (b, S) {
                    return (
                        ...
                        b.start == S.overlayPos && ((b.pos = b.start), (S.overlayCur = v.token(b, S.overlay)), (S.overlayPos = b.pos)),
            ...
            do {
                ...
                if (E) {
                    ...
                    if (c === z && !isNaN(R))
                        y === R && (M = R + 1),
                            y > R && (M = y + 1),
                            S.replaceRange(w.replace(p, z + M + E[4] + E[5]), { line: d, ch: 0 }, { line: d, ch: w.length });
                    else {
...
var ms = Ke((hs, gs) => {
    (function (o) {
        ...
        function p(h) {
            h.state.placeholder && (h.state.placeholder.parentNode.removeChild(h.state.placeholder), (h.state.placeholder = null));
        }
        function v(h) {
            p(h);
        ...
        function C(h) {
            setTimeout(function () {
                ...
                if (h.lineCount() == 1) {
                    ...
                    g = T.nodeName == 'TEXTAREA' ? !h.getLine(0).length : !/[^\u200b]/.test(T.querySelector('.CodeMirror-line').textContent);
                }
                g ? v(h) : p(h);
            }, 20);
        }
        ...
        function S(h) {
            var g = h.getWrapperElement(),
                T = s(h);
            (g.className = g.className.replace(' CodeMirror-empty', '') + (T ? ' CodeMirror-empty' : '')), T ? v(h) : p(h);
        }
        function s(h) {
...
var ys = Ke((vs, bs) => {
    (function (o) {
        ...
        o.defineOption('styleSelectedText', !1, function (x, c, d) {
            ...
            c && !w
                ? ((x.state.markedSelection = []),
                  ...
                  x.on('change', v))
                : !c && w && (x.off('cursorActivity', p), x.off('change', v), h(x), (x.state.markedSelection = x.state.markedSelectionStyle = null));
        });
        function p(x) {
            x.state.markedSelection &&
        ...
        function T(x) {
            ...
            for (S(c, E.from) < 0 && (E.to.line - c.line < C ? (w.shift().clear(), s(x, c, E.to, 0)) : s(x, c, E.from, 0)); S(d, z.to) < 0; )
...
`),
                    ...
                    return { from: p(V, _), to: p(V + j.length - 1, j.length == 1 ? _ + j[0].length : j[j.length - 1].length), match: D };
                }
            }
        }
        function h(y, R, M) {
...
`),
                    ...
                    return { from: p(_, K), to: p(_ + V.length - 1, V.length == 1 ? K + V[0].length : V[V.length - 1].length), match: Q };
                }
            }
        }
        var x, c;
        ...
        function E(y, R, M, H) {
            ...
            e: for (var re = M.line, N = M.ch, F = y.firstLine() - 1 + ee.length; re >= F; re--, N = -1) {
                ...
                if (ee.length == 1) {
                    ...
                    for (var _ = 1, M = re - ee.length + 1; _ < ee.length - 1; _++) if (Z(y.getLine(M + _)) != ee[_]) continue e;
                    var K = y.getLine(re + 1 - ee.length),
                        X = Z(K);
                    if (X.slice(X.length - ee[0].length) != ee[0]) continue e;
                    return { from: p(re + 1 - ee.length, d(K, X, K.length - ee[0].length, Z)), to: p(re, d(D, Q, V.length, Z)) };
                }
            }
        }
        function z(y, R, M, H) {
            (this.atOccurrence = !1), (this.afterEmptyMatch = !1), (this.doc = y), (M = M ? y.clipPos(M) : p(0, 0)), (this.pos = { from: M, to: M });
            var Z;
            ...
            replace: function (y, R) {
                if (this.atOccurrence) {
                    ...
                    this.doc.replaceRange(M, this.pos.from, this.pos.to, R),
                        (this.pos.to = p(this.pos.from.line + M.length - 1, M[M.length - 1].length + (M.length == 1 ? this.pos.from.ch : 0)));
                }
            },
        }),
...
var Vo = Ke((ws, Ss) => {
    (function (o) {
        ...
        function p(I, B, le, xe, q, L) {
            (this.indented = I), (this.column = B), (this.type = le), (this.info = xe), (this.align = q), (this.prev = L);
        }
        ...
        function C(I) {
            ...
            return (B == ')' || B == ']' || B == '}') && (I.indented = I.context.indented), (I.context = I.context.prev);
        }
        function b(I, B, le) {
            if (
        ...
        o.defineMode('clike', function (I, B) {
            ...
            return {
                startState: function (we) {
                    return { tokenize: null, context: new p((we || 0) - le, 0, 'top', null, !1), indented: 0, startOfLine: !0, prevToken: null };
                },
                token: function (we, Me) {
                    var Le = Me.context;
                    if ((we.sol() && (Le.align == null && (Le.align = !1), (Me.indented = we.indentation()), (Me.startOfLine = !0)), we.eatSpace()))
                        return Ue(we, Me), null;
                    ce = Be = null;
                    var $ = (Me.tokenize || te)(we, Me);
                    if ($ == 'comment' || $ == 'meta') return $;
                    if ((Le.align == null && (Le.align = !0), ce == ';' || ce == ':' || (ce == ',' && we.match(/^\s*(?:\/\/.*)?$/, !1))))
                        ...
                        ce == Le.type
                            ? C(Me)
                            : Se &&
                              (((Le.type == '}' || Le.type == 'top') && ce != ';') || (Le.type == 'statement' && ce == 'newstatement')) &&
                              v(Me, we.column(), 'statement', we.current());
                    if (
                        ($ == 'variable' &&
                            (Me.prevToken == 'def' || (B.typeFirstDefinitions && b(we, Me, we.start) && S(Me.context) && we.match(/^\s*\(/, !1))) &&
                            ($ = 'def'),
                        Oe.token)
                    ) {
                ...
                indent: function (we, Me) {
                    if ((we.tokenize != te && we.tokenize != null) || (we.typeAtEndOfLine && S(we.context))) return o.Pass;
                    var Le = we.context,
                        $ = Me && Me.charAt(0),
                        W = $ == Le.type;
        ...
        function Q(I, B) {
            ...
            xe(B.keywords), xe(B.types), xe(B.builtin), xe(B.atoms), le.length && ((B.helperType = I[0]), o.registerHelper('hintWords', I[0], le));
        ...
        Q('text/x-kotlin', {
            ...
            Q('text/x-objectivec++', {
                ...
                types: z,
                builtin: s(c),
                blockKeywords: s(y + ' @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch'),
        ...
        Q('text/x-ceylon', {
            ...
            blockKeywords: s('case catch class dynamic else finally for function if interface module new object switch try while'),
        ...
        o.defineMode('css', function (F, D) {
            ...
            function je(te, fe) {
                ...
                if (oe === '-') {
                    ...
                    if (te.match(/^-[\w\\\-]*/))
                        return (
                            te.eatWhile(/[\w\\\-]/), te.match(/^\s*:/, !1) ? Se('variable-2', 'variable-definition') : Se('variable-2', 'variable')
                        );
                    ...
                    return /[,+>*\/]/.test(oe)
                        ...
                        : oe == '.' && te.match(/^-?[_a-z][_a-z0-9-]*/i)
                          ...
                          : /[:;{}\[\]\(\)]/.test(oe)
                            ? Se(null, oe)
                            : te.match(/^[\w-.]+(?=\()/)
                              ? (/^(url(-prefix)?|domain|regexp)$/i.test(te.current()) && (fe.tokenize = ke), Se('variable callee', 'variable'))
                              : /[\w\\\-]/.test(oe)
            ...
            function ke(te, fe) {
                return te.next(), te.match(/^\s*[\"\')]/, !1) ? (fe.tokenize = null) : (fe.tokenize = Ze(')')), Se(null, '(');
            }
            ...
            return (
                ...
                (Be.block = function (te, fe, oe) {
                    if (te == 'word') {
                        ...
                        return te == 'meta' ? 'block' : !ze && (te == 'hash' || te == 'qualifier') ? ((qe = 'error'), 'block') : Be.top(te, fe, oe);
                }),
                ...
                (Be.prop = function (te, fe, oe) {
                    ...
                    if (te == 'hash' && !/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(fe.current())) qe += ' error';
                ...
                (Be.pseudo = function (te, fe, oe) {
                    return te == 'meta' ? 'pseudo' : te == 'word' ? ((qe = 'variable-3'), oe.context.type) : U(te, fe, oe);
                }),
                (Be.documentTypes = function (te, fe, oe) {
                    return te == 'word' && _.hasOwnProperty(fe.current()) ? ((qe = 'tag'), oe.context.type) : Be.atBlock(te, fe, oe);
                }),
                ...
                (Be.keyframes = function (te, fe, oe) {
                    return te == 'word' ? ((qe = 'variable'), 'keyframes') : te == '{' ? He(oe, fe, 'top') : U(te, fe, oe);
                }),
                ...
                (Be.interpolation = function (te, fe, oe) {
                    return te == '}'
                        ...
                        : te == '{' || te == ';'
                          ? G(te, fe, oe)
                          : (te == 'word' ? (qe = 'variable') : te != 'variable' && te != '(' && te != ')' && (qe = 'error'), 'interpolation');
                }),
                {
                    startState: function (te) {
                        return { tokenize: null, state: Q ? 'block' : 'top', stateArg: null, context: new Je(Q ? 'block' : 'top', te || 0, null) };
                    },
                    ...
                    indent: function (te, fe) {
                        ...
                        return (
                            ...
                            oe.prev &&
                                (Ue == '}' &&
                                (oe.type == 'block' || oe.type == 'top' || oe.type == 'interpolation' || oe.type == 'restricted_atBlock')
        ...
        o.defineMIME('text/css', {
            ...
            o.defineMIME('text/x-scss', {
                ...
                tokenHooks: {
                    ...
                    $: function (F) {
                        return F.match(/^[\w-]+/), F.match(/^\s*:/, !1) ? ['variable-2', 'variable-definition'] : ['variable-2', 'variable'];
                    },
                    '#': function (F) {
            ...
            o.defineMIME('text/x-less', {
                ...
                tokenHooks: {
                    ...
                    '@': function (F) {
                        return F.eat('{')
                            ? [null, 'interpolation']
                            : F.match(/^(charset|document|font-face|import|(-(moz|ms|o|webkit)-)?keyframes|media|namespace|page|supports)\b/i, !1)
                              ? !1
                              : (F.eatWhile(/[\w\\\-]/), F.match(/^\s*:/, !1) ? ['variable-2', 'variable-definition'] : ['variable-2', 'variable']);
                    },
                    '&': function () {
                        return ['atom', 'atom'];
                    },
        ...
        o.defineMode('diff', function () {
            ...
            return {
                token: function (v) {
                    ...
                    if (!v.sol() || C === 0) return v.skipToEnd(), ('error ' + (p[v.string.charAt(0)] || '')).replace(/ $/, '');
...
var mn = Ke((qs, Is) => {
    (function (o) {
        ...
        o.defineMode('xml', function (C, b) {
            ...
            function d(_, K) {
                var X = _.next();
                if (X == '>' || (X == '/' && _.eat('>'))) return (K.tokenize = c), (T = X == '>' ? 'endTag' : 'selfcloseTag'), 'tag bracket';
            ...
            function H(_, K) {
                for (var X; ; ) {
                    if (
                        !_.context ||
                        ((X = _.context.tagName), !s.contextGrabbers.hasOwnProperty(y(X)) || !s.contextGrabbers[y(X)].hasOwnProperty(y(K)))
                    )
                        return;
                    M(_);
                }
            ...
            function re(_, K, X) {
                if (_ == 'word') {
                    var I = K.current();
                    return (
                        X.context && X.context.tagName != I && s.implicitlyClosed.hasOwnProperty(y(X.context.tagName)) && M(X),
                        (X.context && X.context.tagName == I) || s.matchClosing === !1 ? ((x = 'tag'), N) : ((x = 'tag error'), F)
                    );
                } else return s.allowMissingTagName && _ == 'endTag' ? ((x = 'tag bracket'), N(_, K, X)) : ((x = 'error'), F);
            }
            function N(_, K, X) {
            ...
            function j(_, K, X) {
                return _ == 'string' ? V : _ == 'word' && s.allowUnquoted ? ((x = 'string'), D) : ((x = 'error'), D(_, K, X));
            }
            function V(_, K, X) {
            ...
            return {
                ...
                token: function (_, K) {
                    ...
                    return (
                        (X || T) && X != 'comment' && ((x = null), (K.state = K.state(T || X, _, K)), x && (X = x == 'error' ? X + ' error' : x)), X
                    );
                },
                indent: function (_, K, X) {
                    var I = _.context;
                    if (_.tokenize.isInAttribute) return _.tagStart == _.indented ? _.stringStartCol + 1 : _.indented + S;
    ...
    (function (o) {
        ...
        o.defineMode('javascript', function (p, v) {
            ...
            function R(k, O) {
                ...
                if (/\d/.test(ae)) return k.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), y('number', 'number');
                if (ae == '/')
                    return k.eat('*')
                        ? ((O.tokenize = H), H(k, O))
                        : k.eat('/')
                ...
                if ((ae == '<' && k.match('!--')) || (ae == '-' && k.match('->') && !/\S/.test(k.string.slice(0, k.start))))
                    return k.skipToEnd(), y('comment', 'comment');
                if (c.test(ae))
                    return (
                        (ae != '>' || !O.lexical || O.lexical.type != '>') &&
                            (k.eat('=') ? (ae == '!' || ae == '=') && k.eat('=') : /[<>*+\-|&?]/.test(ae) && (k.eat(ae), ae == '>' && k.eat(ae))),
                ...
                if (T.test(ae)) {
                    ...
                    if (O.lastType != '.') {
                        ...
                        if (he == 'async' && k.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1)) return y('async', 'keyword', he);
                    }
            ...
            function F(k, O, ae, he, ne, ye) {
                (this.indented = k), (this.column = O), (this.type = ae), (this.prev = ne), (this.info = ye), he != null && (this.align = he);
            }
            function D(k, O) {
                if (!h) return !1;
                for (var ae = k.localVars; ae; ae = ae.next) if (ae.name == O) return !0;
                for (var he = k.context; he; he = he.prev) for (var ae = he.vars; ae; ae = ae.next) if (ae.name == O) return !0;
            }
            function Q(k, O, ae, he, ne) {
                var ye = k.cc;
                for (
                    j.state = k, j.stream = ne, j.marked = null, j.cc = ye, j.style = O, k.lexical.hasOwnProperty('align') || (k.lexical.align = !0);
                    ;
            ...
            function Ee() {
                var k = j.state;
                k.lexical.prev && (k.lexical.type == ')' && (k.indented = k.lexical.indented), (k.lexical = k.lexical.prev));
            }
            Ee.lex = !0;
            function ge(k) {
                function O(ae) {
                          ...
                          : k == 'debugger'
                            ...
                            : k == '{'
                              ...
                              : k == ';'
                                ? _()
                                : k == 'if'
                                  ? (j.state.lexical.info == 'else' && j.state.cc[j.state.cc.length - 1] == Ee && j.state.cc.pop()(),
                                      ...
                                      : k == 'class' || (g && O == 'interface')
                                        ...
                                        : k == 'variable'
                                          ? g && O == 'declare'
                                              ...
                                              : g && (O == 'module' || O == 'enum' || O == 'type') && j.stream.match(/^\s*\w/, !1)
                                                ? ((j.marked = 'keyword'),
                                                  O == 'enum'
                                                      ? _(Ae)
                                                      : O == 'type'
            ...
            function Ge(k, O, ae) {
                ...
                if (k != ';') {
                    ...
                    if (k == 'regexp') return (j.state.lastType = j.marked = 'operator'), j.stream.backUp(j.stream.pos - j.stream.start - 1), _(ne);
                }
            }
            function U(k, O) {
            ...
            function Me(k, O) {
                ...
                if (k == 'variable' || j.style == 'keyword') {
                    ...
                    if (k == 'number' || k == 'string') return (j.marked = S ? 'property' : j.style + ' property'), _($);
            ...
            function Pe(k, O) {
                if (O == 'keyof' || O == 'typeof' || O == 'infer' || O == 'readonly') return (j.marked = 'keyword'), _(O == 'typeof' ? je : Pe);
            ...
            function ot(k, O) {
                return (k == 'variable' && j.stream.match(/^\s*[?:]/, !1)) || O == '?' ? _(ot) : k == ':' ? _(Pe) : k == 'spread' ? _(ot) : V(Pe);
            }
            function Ht(k, O) {
            ...
            function dr(k, O) {
                return k == 'variable' && !j.stream.match(/^\s*:/, !1)
                    ...
                    : (k == 'variable' && (j.marked = 'property'),
                      k == 'spread' ? _(Ct) : k == '}' ? V() : k == '[' ? _(Se, ge(']'), ge(':'), dr) : _(ge(':'), Ct, Ut));
            }
            function yn() {
                return V(Ct, Ut);
            }
            ...
            function pr(k, O) {
                return k == ')' ? _() : k == ';' ? _(pr) : O == 'in' || O == 'of' ? ((j.marked = 'keyword'), _(Se, pr)) : V(Se, pr);
            }
            function Bt(k, O) {
            ...
            function $t(k, O) {
                return (
                    O == '@' && _(Se, $t),
                    k == 'spread' ? _($t) : g && B(O) ? ((j.marked = 'keyword'), _($t)) : g && k == 'this' ? _(nt, Ut) : V(Ct, nt, Ut)
                );
            }
            function to(k, O) {
            ...
            function Kt(k, O) {
                ...
                if (O == 'extends' || O == 'implements' || (g && k == ',')) return O == 'implements' && (j.marked = 'keyword'), _(g ? Pe : Se, Kt);
                if (k == '{') return _(pe('}'), Gt, Ee);
            }
            function Gt(k, O) {
                if (
                    k == 'async' ||
                    (k == 'variable' && (O == 'static' || O == 'get' || O == 'set' || (g && B(O))) && j.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1))
                )
            ...
            function jt(k, O, ae) {
                return (
                    (O.tokenize == R && /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(O.lastType)) ||
            ...
            return {
                ...
                token: function (k, O) {
                    if (
                        (k.sol() && (O.lexical.hasOwnProperty('align') || (O.lexical.align = !1), (O.indented = k.indentation()), re(k, O)),
                        O.tokenize != H && k.eatSpace())
                    )
                        return null;
                    var ae = O.tokenize(k, O);
                    return E == 'comment' ? ae : ((O.lastType = E == 'operator' && (z == '++' || z == '--') ? 'incdec' : E), Q(O, ae, E, z, k));
                },
                indent: function (k, O) {
                    ...
                    for (
                        ...
                        (ae == '}' || ((ne = k.cc[k.cc.length - 1]) && (ne == He || ne == Ge) && !/^[,\.=+\-*:?[\(]/.test(O)));
...
var Qn = Ke((Os, Ps) => {
    (function (o) {
        ...
        function v(T, x, c) {
            var d = T.current(),
                w = d.search(x);
            return w > -1 ? T.backUp(d.length - w) : d.match(/<\/?$/) && (T.backUp(d.length), T.match(x, !1) || T.match(d)), c;
        }
        var C = {};
        function b(T) {
            var x = C[T];
        ...
        o.defineMode(
            ...
            function (T, x) {
                var c = o.getMode(T, {
                    ...
                    w = x && x.tags,
                    E = x && x.scriptTypes;
                if ((h(p, d), w && h(w, d), E)) for (var z = E.length - 1; z >= 0; z--) d.script.unshift(['type', E[z].matches, E[z].mode]);
                function y(R, M) {
                    var H = c.token(R, M.htmlState),
                        Z = /\btag\b/.test(H),
                        ee;
                    if (Z && !/[<>\s\/]/.test(R.current()) && (ee = M.htmlState.tagName && M.htmlState.tagName.toLowerCase()) && d.hasOwnProperty(ee))
                        M.inTag = ee + ' ';
                ...
                return {
                    ...
                    copyState: function (R) {
                        ...
                        return (
                            ...
                            { token: R.token, inTag: R.inTag, localMode: R.localMode, localState: M, htmlState: o.copyState(c, R.htmlState) }
                        );
                    },
                    token: function (R, M) {
                        return M.token(R, M);
...
var Hs = Ke((js, Rs) => {
    (function (o) {
        ...
        o.defineMode('django:inner', function () {
                          ...
                          : c.match("'")
                            ...
                            : c.match('"')
                              ...
                              : c.match(/\b(\w+)\b/) && !d.foundVariable
                                ...
                                : c.match('}}')
                                  ? ((d.waitProperty = null), (d.waitFilter = null), (d.waitDot = null), (d.waitPipe = null), (d.tokenize = S), 'tag')
                                  : (c.next(), 'null');
            }
            function g(c, d) {
                if (d.waitDot) {
                ...
                if (d.waitProperty && ((d.waitProperty = !1), c.match(/\b(\w+)\b/))) return (d.waitDot = !0), (d.waitPipe = !0), 'property';
            ...
            function x(c, d) {
                return c.match(/\{%\s*endcomment\s*%\}/, !1) ? ((d.tokenize = g), c.match('{%'), 'tag') : (c.next(), 'comment');
            }
            return {
                startState: function () {
                    return { tokenize: S };
...
var Di = Ke((Bs, Ws) => {
    (function (o) {
            ...
            (o.simpleMode = function (x, c) {
                ...
                var Z = {
                    ...
                    copyState: function (re) {
                        var N = { state: re.state, pending: re.pending, local: re.local, localState: null, indent: re.indent && re.indent.slice(0) };
                        re.localState && (N.localState = o.copyState(re.local.mode, re.localState)), re.stack && (N.stack = re.stack.slice(0));
        ...
        function v(x, c) {
            ...
            var d = '';
            return (
                x instanceof RegExp ? (x.ignoreCase && (d = 'i'), x.unicode && (d += 'u'), (x = x.source)) : (x = String(x)),
                new RegExp((c === !1 ? '' : '^') + '(?:' + x + ')', d)
            );
        }
        function C(x) {
        ...
        function b(x, c) {
            (x.next || x.push) && p(c, x.next || x.push), (this.regex = v(x.regex)), (this.token = C(x.token)), (this.data = x);
        }
        function S(x, c) {
            return function (d, w) {
                if (w.pending) {
                ...
                if (w.local)
                    if (w.local.end && d.match(w.local.end)) {
                        ...
                        var z = w.local.mode.token(d, w.localState),
                            y;
                        return w.local.endScan && (y = w.local.endScan.exec(d.current())) && (d.pos = d.start + y.index), z;
                    }
        ...
        function h(x, c, d, w) {
            var E;
            if (d.persistent) for (var z = c.persistentStates; z && !E; z = z.next) (d.spec ? s(d.spec, z.spec) : d.mode == z.mode) && (E = z);
        ...
        function T(x, c) {
            return function (d, w, E) {
                ...
                if (d.indent == null || d.local || (c.dontIndentStates && g(d.state, c.dontIndentStates) > -1)) return o.Pass;
            ...
            function (p, v) {
                ...
                function ee(q) {
                    if (
                        ...
                        if (!L) {
                            ...
                            L = de.mode.name == 'xml' && de.state.tagStart === null && !de.state.context && de.state.tokenize.isInText;
                        }
                        L && ((q.f = j), (q.block = re), (q.htmlState = null));
                    }
                    return (q.trailingSpace = 0), (q.trailingSpaceNewLine = !1), (q.prevLine = q.thisLine), (q.thisLine = { stream: null }), null;
                }
                function re(q, L) {
                    ...
                    if (L.indentationDiff === null && ((L.indentationDiff = L.indentation), ge)) {
                        for (L.list = null; qe < L.listStack[L.listStack.length - 1]; )
                            L.listStack.pop(), L.listStack.length ? (L.indentation = L.listStack[L.listStack.length - 1]) : (L.list = !1);
                    ...
                    if (L.indentation <= Oe && q.eat('>'))
                        return (L.quote = de ? 1 : L.quote + 1), v.highlightFormatting && (L.formatting = 'quote'), q.eatSpace(), D(L);
                    if (!je && !L.setext && de && L.indentation <= Oe && (Ze = q.match(T))) {
                        ...
                        if (de && L.indentation <= Oe && (Ze = q.match(E, !0)))
                            return (
                                ...
                                (L.localMode = v.fencedCodeBlockHighlighting && S(Ze[2] || v.fencedCodeBlockDefaultMode)),
                        ...
                        if (
                            ...
                            return (
                                L.setext
                                    ? ((L.header = L.setext), (L.setext = 0), q.skipToEnd(), v.highlightFormatting && (L.formatting = 'header'))
                ...
                function N(q, L) {
                    ...
                    if (!b) {
                        ...
                        ((ze.mode.name == 'xml' && ze.state.tagStart === null && !ze.state.context && ze.state.tokenize.isInText) ||
                    ...
                    if (q.formatting) {
                        ...
                        for (var de = 0; de < q.formatting.length; de++)
                            L.push(s.formatting + '-' + q.formatting[de]),
                                q.formatting[de] === 'header' && L.push(s.formatting + '-' + q.formatting[de] + '-' + q.header),
                ...
                function j(q, L) {
                    ...
                    if (L.taskList) {
                        ...
                        return (
                            ze ? (L.taskOpen = !0) : (L.taskClosed = !0), v.highlightFormatting && (L.formatting = 'task'), (L.taskList = !1), D(L)
                        );
                    }
                    ...
                    if (pe === '!' && q.match(/\[[^\]]*\] ?(?:\(|\[)/, !1))
                        return (L.imageMarker = !0), (L.image = !0), v.highlightFormatting && (L.formatting = 'image'), D(L);
                    if (pe === '[' && L.imageMarker && q.match(/[^\]]*\](\(.*?\)| ?\[.*?\])/, !1))
                        return (L.imageMarker = !1), (L.imageAltText = !0), v.highlightFormatting && (L.formatting = 'image'), D(L);
                    ...
                    if (pe === '[' && !L.image)
                        return (L.linkText && q.match(/^.*?\]/)) || ((L.linkText = !0), v.highlightFormatting && (L.formatting = 'link')), D(L);
                    if (pe === ']' && L.linkText) {
                    ...
                    if (v.xml && pe === '<' && q.match(/^(!--|\?|!\[CDATA\[|[a-z][a-z0-9-]*(?:\s+[a-z_:.\-]+(?:\s*=\s*[^>]+)?)*\s*(?:>|$))/i, !1)) {
                    ...
                    if (pe === '*' || pe === '_') {
                        for (var He = 1, Ge = q.pos == 1 ? ' ' : q.string.charAt(q.pos - 2); He < 3 && q.eat(pe); ) He++;
                        var U = q.peek() || ' ',
                        ...
                        if (
                            ...
                            v.highlightFormatting && (L.formatting = Be == null ? 'strong' : te == null ? 'em' : 'strong em'),
                                Be === !0 && (L.em = pe),
                                te === !0 && (L.strong = pe);
                            var Se = D(L);
                    ...
                    if (v.strikethrough) {
                        if (pe === '~' && q.eatWhile(pe)) {
                            if (L.strikethrough) {
                                ...
                                return (L.strikethrough = !0), v.highlightFormatting && (L.formatting = 'strikethrough'), D(L);
                    ...
                    return pe === ' ' && (q.match(/^ +$/, !1) ? L.trailingSpace++ : L.trailingSpace && (L.trailingSpaceNewLine = !0)), D(L);
                }
                function V(q, L) {
                    var de = q.next();
                    if (de === '>') {
                ...
                function I(q, L) {
                    return q.match(/^([^\]\\]|\\.)*\]:/, !1)
                        ? ((L.f = B), q.next(), v.highlightFormatting && (L.formatting = 'link'), (L.linkText = !0), D(L))
                        : M(q, L, j);
                }
                function B(q, L) {
                    if (q.match(']:', !0)) {
        ...
        o.defineMode(
            ...
            function (v, C) {
                ...
                var s = {
                        ...
                        token: function (T, x) {
                            if (((x.combineTokens = null), x.codeBlock)) return T.match(/^```+/) ? ((x.codeBlock = !1), null) : (T.skipToEnd(), null);
                            if ((T.sol() && (x.code = !1), T.sol() && T.match(/^```+/))) return T.skipToEnd(), (x.codeBlock = !0), null;
                            if (T.peek() === '`') {
                                T.next();
                                var c = T.pos;
                                T.eatWhile('`');
                            ...
                            if ((T.sol() || x.ateSpace) && ((x.ateSpace = !1), C.gitHubSpice !== !1)) {
                                if (T.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+@)?(?=.{0,6}\d)(?:[a-f0-9]{7,40}\b)/))
                                    return (x.combineTokens = !0), 'link';
                                if (T.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+)?#[0-9]+\b/)) return (x.combineTokens = !0), 'link';
                            }
                            return T.match(p) &&
        ...
        o.defineMode('go', function (p) {
            ...
            function d(w) {
                if (w.context.prev) {
                    ...
                    return (E == ')' || E == ']' || E == '}') && (w.indented = w.context.indented), (w.context = w.context.prev);
                }
            }
            return {
...
var au = Ke((iu, ou) => {
    (function (o) {
        ...
        o.defineMode('http', function () {
            ...
            function h(T) {
                return T.sol() && !T.eat(/[ \t]/) ? (T.match(/^.*?:/) ? 'atom' : (T.skipToEnd(), 'error')) : (T.skipToEnd(), 'string');
            }
            function g(T) {
...
var uu = Ke((lu, su) => {
    (function (o) {
        ...
        o.defineMode('jinja2', function () {
            ...
            function s(h, g) {
                var T = h.peek();
                if (g.incomment) return h.skipTo('#}') ? (h.eatWhile(/\#|}/), (g.incomment = !1)) : h.skipToEnd(), 'comment';
                if (g.intag) {
                    if (g.operator) {
                    ...
                    if (g.inbraces > 0 && T == ')') h.next(), g.inbraces--;
                        ...
                        if (!g.lineTag && (h.match(g.intag + '}') || (h.eat('-') && h.match(g.intag + '}')))) return (g.intag = !1), 'tag';
                    ...
                    if (h.eat('#')) return (g.incomment = !0), h.skipTo('#}') ? (h.eatWhile(/\#|}/), (g.incomment = !1)) : h.skipToEnd(), 'comment';
                    if ((T = h.eat(/\{|%/)))
                        return (g.intag = T), (g.inbraces = 0), (g.inbrackets = 0), T == '{' && (g.intag = '}'), h.eat('-'), 'tag';
                } else if (h.eat('#')) {
            ...
            return {
                ...
                token: function (h, g) {
                    ...
                    return h.eol() && g.lineTag && !g.instring && g.inbraces == 0 && g.inbrackets == 0 && ((g.intag = !1), (g.lineTag = !1)), T;
                },
                blockCommentStart: '{#',
                blockCommentEnd: '#}',
                lineComment: '##',
...
var du = Ke((cu, fu) => {
    (function (o) {
        ...
        o.defineMode(
            'jsx',
            function (C, b) {
                var S = o.getMode(C, { name: 'xml', allowMissing: !0, multilineTagIndentPastTag: !1, allowMissingTagName: !0 }),
                ...
                function T(c, d, w) {
                    ...
                    if (c.peek() == '{') {
                        ...
                        if (z && c.match(/^[^>]*>\s*$/, !1)) {
                            ...
                            z.startOfLine ? (E -= C.indentUnit) : w.prev.state.lexical && (E = w.prev.state.lexical.indented);
                        } else w.depth == 1 && (E += C.indentUnit);
                        return (d.context = new p(o.startState(s, E), s, 0, d.context)), null;
                    }
                    if (w.depth == 1) {
                        if (c.peek() == '<') return S.skipAttribute(w.state), (d.context = new p(o.startState(S, h(w.state)), S, 0, d.context)), null;
                ...
                function x(c, d, w) {
                    if (c.peek() == '<' && !c.match(/^<([^<>]|<[^>]*>)+,\s*>/, !1) && s.expressionAllowed(c, w.state))
                        return (d.context = new p(o.startState(S, s.indent(w.state, '', '')), S, 0, d.context)), s.skipExpression(w.state), null;
    ...
    (function (o) {
        ...
        o.defineMode('nginx', function (p) {
            ...
            var C = v(
                ...
                S = v('include root server server_name listen internal proxy_pass memcached_pass fastcgi_pass try_files'),
                s = p.indentUnit,
                h;
            function g(w, E) {
                return (h = E), w;
    ...
    (function (o) {
        ...
        o.defineMode('perl', function () {
                ...
                return (
                    ...
                    (d.tokenize = function (y, R) {
                        for (var M = !1, H, Z = 0; (H = y.next()); ) {
                            if (H === w[Z] && !M)
                                return w[++Z] !== void 0 ? ((R.chain = w[Z]), (R.style = E), (R.tail = z)) : z && y.eatWhile(z), (R.tokenize = x), E;
                            M = !M && H == '\\';
                        }
                        return E;
                    }),
            ...
            function x(c, d) {
                ...
                if (c.match(/^(\-?((\d[\d_]*)?\.\d+(e[+-]?\d+)?|\d+\.\d*)|0x[\da-fA-F_]+|0b[01_]+|\d[\d_]*(e[+-]?\d+)?)/)) return 'number';
                ...
                if (/[$@%]/.test(w)) {
                    var E = c.pos;
                    if ((c.eat('^') && c.eat(/[A-Z]/)) || (!/[@$%&]/.test(p(c, -2)) && c.eat(/[=|\\\-#?@;:&`~\^!\[\]*'"$+.,\/<>()]/))) {
                        var y = c.current();
    ...
    (function (o) {
        ...
        function v(T, x, c) {
            return T.length == 0
                ? C(x)
                : function (d, w) {
                      for (var E = T[0], z = 0; z < E.length; z++) if (d.match(E[z][0])) return (w.tokenize = v(T.slice(1), x)), E[z][1];
        ...
        function b(T, x, c, d) {
            ...
            for (var w = !1; !T.eol() && (w || d === !1 || (!T.match('{$', !1) && !T.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*|\$\{)/, !1))); ) {
                if (!w && T.match(c)) {
        ...
        var S =
            ...
            s = 'true false null TRUE FALSE NULL __CLASS__ __DIR__ __FILE__ __LINE__ __METHOD__ __FUNCTION__ __NAMESPACE__ __TRAIT__',
            h =
        ...
        o.registerHelper('hintWords', 'php', [S, s, h].join(' ').split(' ')), o.registerHelper('wordChars', 'php', /[\w$]/);
        var g = {
            name: 'clike',
            helperType: 'php',
            keywords: p(S),
            ...
            hooks: {
                ...
                '<': function (T, x) {
                    ...
                    if ((c = T.match(/^<<\s*/))) {
                        ...
                        if ((d && T.eat(d), w)) return (x.tokStack || (x.tokStack = [])).push(w, 0), (x.tokenize = C(w, d != "'")), 'string';
                    }
                    return !1;
                },
                '#': function (T) {
        ...
        o.defineMode(
            ...
            function (T, x) {
                ...
                function w(E, z) {
                    ...
                    if (E.match(/^<\?\w*/))
                        return (z.curMode = d), z.php || (z.php = o.startState(d, c.indent(z.html, '', ''))), (z.curState = z.php), 'meta';
                ...
                return {
                    startState: function () {
                        ...
                        return { html: E, php: z, curMode: x.startOpen ? d : c, curState: x.startOpen ? z : E, pending: null };
                    },
                    copyState: function (E) {
                        var z = E.html,
                            ...
                            M = R && o.copyState(d, R),
                            H;
                        return E.curMode == c ? (H = y) : (H = M), { html: y, php: M, curMode: E.curMode, curState: H, pending: E.pending };
                    },
                    token: w,
        ...
        function S(s) {
            return s.eatSpace()
                ...
                : s.match('//')
                  ? (s.skipToEnd(), 'comment')
                  : s.match(/^[0-9\.+-]/, !1) &&
                      (s.match(/^[+-]?0x[0-9a-fA-F]+/) || s.match(/^[+-]?\d*\.\d+([EeDd][+-]?\d+)?/) || s.match(/^[+-]?\d+([EeDd][+-]?\d+)?/))
                    ? 'number'
                    : s.match(/^"([^"]|(""))*"/) || s.match(/^'([^']|(''))*'/)
                      ? 'string'
                      : s.match(C)
    ...
    (function (o) {
        ...
        o.defineMode('python', function (h, g) {
            ...
            var w = g.hangingIndent || h.indentUnit,
                E = C,
                z = b;
            g.extra_keywords != null && (E = E.concat(g.extra_keywords)), g.extra_builtins != null && (z = z.concat(g.extra_builtins));
            ...
            function re(K, X, I) {
                ...
                if (K.match(/^[0-9\.]/, !1)) {
                    var B = !1;
                    if ((K.match(/^[\d_]*\.\d+(e[\+\-]?\d+)?/i) && (B = !0), K.match(/^[\d_]+\.\d*/) && (B = !0), K.match(/^\.\d+/) && (B = !0), B))
            ...
            var _ = {
                ...
                indent: function (K, X) {
                    ...
                    var I = S(K),
                        B = I.type == X.charAt(0) || (I.type == 'py' && !K.dedent && /^(else:|elif |except |finally:)/.test(X));
        ...
        o.defineMode('ruby', function (g) {
            ...
            function c(M, H) {
                ...
                if (Z == '%') {
                    ...
                    if (Z == '<' && (ee = M.match(/^<([-~])[\`\"\']?([a-zA-Z_?]\w*)[\`\"\']?(?:;|$)/))) return x(y(ee[2], ee[1]), M, H);
                    if (Z == '0') return M.eat('x') ? M.eatWhile(/[\da-fA-F]/) : M.eat('b') ? M.eatWhile(/[01]/) : M.eatWhile(/[0-7]/), 'number';
                                  ...
                                  : M.eat(/[\<\>]/)
                                    ...
                                    : M.eat(/[\+\-\*\/\&\|\:\!]/)
                                      ...
                                      : M.eat(/[a-zA-Z$@_\xa1-\uffff]/)
                                        ...
                                        : 'operator';
                        if (Z == '@' && M.match(/^@?[a-zA-Z_\xa1-\uffff]/)) return M.eat('@'), M.eatWhile(/[\w\xa1-\uffff]/), 'variable-2';
                        if (Z == '$') return M.eat(/[a-zA-Z_]/) ? M.eatWhile(/[\w]/) : M.eat(/\d/) ? M.eat(/\d/) : M.next(), 'variable-3';
                        if (/[a-zA-Z_\xa1-\uffff]/.test(Z)) return M.eatWhile(/[\w\xa1-\uffff]/), M.eat(/[\?\!]/), M.eat(':') ? 'atom' : 'ident';
            ...
            function z(M, H, Z, ee) {
                return function (re, N) {
                    var F = !1,
                        D;
                    for (N.context.type === 'read-quoted-paused' && ((N.context = N.context.prev), re.eat('}')); (D = re.next()) != null; ) {
                        if (D == M && (ee || !F)) {
                            N.tokenize.pop();
                            break;
                        }
                        if (Z && D == '#' && !F) {
                            if (re.eat('{')) {
                                M == '}' && (N.context = { prev: N.context, type: 'read-quoted-paused' }), N.tokenize.push(w());
                                break;
            ...
            return {
                ...
                indent: function (M, H) {
                    ...
                    var Z = H && H.charAt(0),
                        ee = M.context,
                        re = ee.type == h[Z] || (ee.type == 'keyword' && /^(?:end|until|else|elsif|when|rescue)\b/.test(H));
        ...
        o.defineMode(
            ...
            function (p) {
                ...
                function y(N, F) {
                    return function (D, Q) {
                        return D.sol() && D.indentation() <= N
                            ...
                            : (F && D.skipTo('*/') ? (D.next(), D.next(), (Q.tokenizer = ee)) : D.skipToEnd(), 'comment');
                    };
                }
                function R(N, F) {
                    F == null && (F = !0);
                ...
                function ee(N, F) {
                    ...
                    if (F.cursorHalf) {
                        if ((D === '#' && (N.next(), N.match(/[0-9a-fA-F]{6}|[0-9a-fA-F]{3}/))) || N.match(/^-?[0-9\.]+/))
                        ...
                        if (N.match(/^url/) && N.peek() === '(') return (F.tokenizer = z), E(N) && (F.cursorHalf = 0), 'atom';
                ...
                function re(N, F) {
                    ...
                    if (((Q === '@return' || Q === '}') && Z(F), D !== null)) {
                        for (var j = N.pos - Q.length, V = j + p.indentUnit * F.indentCount, _ = [], K = 0; K < F.scopes.length; K++) {
                            var X = F.scopes[K];
                            X.offset <= V && _.push(X);
                        }
                        F.scopes = _;
    ...
    (function (o) {
        ...
        o.defineMode('shell', function () {
            ...
            function s(d, w) {
                ...
                if (z === "'" || z === '"' || z === '`') return w.tokens.unshift(h(z, z === '`' ? 'quote' : 'string')), c(d, w);
    ...
    (function (o) {
        ...
        o.defineMode('sql', function (g, T) {
            ...
            function ee(Q, j) {
                ...
                if (z.hexNumber && ((V == '0' && Q.match(/^[xX][0-9a-fA-F]+/)) || ((V == 'x' || V == 'X') && Q.match(/^'[0-9a-fA-F]*'/))))
                    return 'number';
                if (z.binaryNumber && (((V == 'b' || V == 'B') && Q.match(/^'[01]*'/)) || (V == '0' && Q.match(/^b[01]+/)))) return 'number';
                if (V.charCodeAt(0) > 47 && V.charCodeAt(0) < 58)
                    return Q.match(/^[0-9]*(\.[0-9]+)?([eE][-+]?[0-9]+)?/), z.decimallessFloat && Q.match(/^\.(?!\.)/), 'number';
                if (V == '?' && (Q.eatSpace() || Q.eol() || Q.eat(';'))) return 'variable-3';
                if (V == "'" || (V == '"' && z.doubleQuote)) return (j.tokenize = re(V)), j.tokenize(Q, j);
                if (
                    ((z.nCharCast && (V == 'n' || V == 'N')) || (z.charsetCast && V == '_' && Q.match(/[a-z][a-z0-9]*/i))) &&
                    (Q.peek() == "'" || Q.peek() == '"')
                )
                    return 'keyword';
                if (z.escapeConstant && (V == 'e' || V == 'E') && (Q.peek() == "'" || (Q.peek() == '"' && z.doubleQuote)))
                    return (
                ...
                if (V == '.') {
                    ...
                    if (V == '{' && (Q.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/) || Q.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/)))
                        return 'number';
                    Q.eatWhile(/^[_\w\d]/);
            ...
            function N(Q) {
                return function (j, V) {
                    var _ = j.match(/^.*?(\/\*|\*\/)/);
                    return (
                        _ ? (_[1] == '/*' ? (V.tokenize = N(Q + 1)) : Q > 1 ? (V.tokenize = N(Q - 1)) : (V.tokenize = ee)) : j.skipToEnd(), 'comment'
                    );
                };
            }
            function F(Q, j, V) {
            ...
            return {
                ...
                token: function (Q, j) {
                    if ((Q.sol() && j.context && j.context.align == null && (j.context.align = !1), j.tokenize == ee && Q.eatSpace())) return null;
                    var V = j.tokenize(Q, j);
                    if (V == 'comment') return V;
                    j.context && j.context.align == null && (j.context.align = !0);
                    var _ = Q.current();
                    return _ == '(' ? F(Q, j, ')') : _ == '[' ? F(Q, j, ']') : j.context && j.context.type == _ && D(j), V;
                },
                indent: function (Q, j) {
                    var V = Q.context;
                    if (!V) return o.Pass;
        ...
        o.defineMIME('text/x-sql', {
            ...
            o.defineMIME('text/x-pgsql', {
                ...
                backslashStringEscapes: !1,
                dateSQL: s('date time timestamp'),
                support: s('decimallessFloat zerolessFloat binaryNumber hexNumber nCharCast charsetCast escapeConstant'),
            }),
    ...
    (function (o) {
        ...
        o.defineMode('stylus', function (M) {
            ...
            function Oe($, W) {
                ...
                if (ze == '#') {
                    if (($.next(), $.match(/^[0-9a-f]{3}([0-9a-f]([0-9a-f]{2}){0,2})?\b(?!-)/i))) return ['atom', 'atom'];
            ...
            return (
                (de.block = function ($, W, se) {
                    ...
                    if (Me(W) && $ == ']' && !/^\s*(\.|#|:|\[|\*|&)/.test(W.string) && !U(Le(W))) return ke(se, W, 'block', 0);
                    if (fe($, W)) return ke(se, W, 'block');
                    if ($ == '}' && Me(W)) return ke(se, W, 'block', 0);
                    if ($ == 'variable-name')
                        return W.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/) || ce(Le(W)) ? ke(se, W, 'variableName') : ke(se, W, 'variableName', 0);
                    if ($ == '=') return !Me(W) && !ce(Le(W)) ? ke(se, W, 'block', 0) : ke(se, W, 'block');
                    if ($ == '*' && (Me(W) || W.match(/\s*(,|\.|#|\[|:|{)/, !1))) return (ge = 'tag'), ke(se, W, 'block');
                    if (Ue($, W)) return ke(se, W, 'pseudo');
                    if (/@(font-face|media|supports|(-moz-)?document)/.test($)) return ke(se, W, Me(W) ? 'block' : 'atBlock');
                    ...
                    if ($ == 'word') {
                        var De = W.current();
                        if (((ge = te(De)), ge == 'property')) return we(W) ? ke(se, W, 'block', 0) : ((ge = 'atom'), 'block');
                        if (ge == 'tag') {
                            if (
                            ...
                            if (
                                re.test(De) &&
                                ((we(W) && W.string.match(/=/)) || (!we(W) && !W.string.match(/^(\s*\.|#|\&|\[|\/|>|\*)/) && !U(Le(W))))
                            )
                                return (ge = 'variable-2'), ce(Le(W)) ? 'block' : ke(se, W, 'block', 0);
                            if (Me(W)) return ke(se, W, 'block');
                        }
                        if (ge == 'block-keyword') return (ge = 'keyword'), W.current(/(if|unless)/) && !we(W) ? 'block' : ke(se, W, 'block');
                ...
                (de.parens = function ($, W, se) {
                    ...
                    if (($ && $.charAt(0) == '@' && G(W.current().slice(1)) && (ge = 'variable-2'), $ == 'word')) {
                        var De = W.current();
                        (ge = te(De)), ge == 'tag' && re.test(De) && (ge = 'variable-2'), (ge == 'property' || De == 'to') && (ge = 'atom');
                    }
                    return $ == 'variable-name' ? ke(se, W, 'variableName') : Ue($, W) ? ke(se, W, 'pseudo') : se.context.type;
                }),
                (de.vendorPrefixes = function ($, W, se) {
                    return $ == 'word' ? ((ge = 'property'), ke(se, W, 'block', 0)) : Je(se);
                }),
                (de.pseudo = function ($, W, se) {
                    return G(Le(W.string)) ? Ge($, W, se) : (W.match(/^[a-z-]+/), (ge = 'variable-3'), Me(W) ? ke(se, W, 'block') : Je(se));
                }),
                ...
                (de.keyframes = function ($, W, se) {
                    return W.indentation() == '0' && (($ == '}' && we(W)) || $ == ']' || $ == 'hash' || $ == 'qualifier' || U(W.current()))
                        ? Ge($, W, se)
                        : $ == '{'
                          ? ke(se, W, 'keyframes')
                          : $ == '}'
                ...
                (de.interpolation = function ($, W, se) {
                    return (
                        $ == '{' && Je(se) && ke(se, W, 'block'),
                        $ == '}'
                            ? W.string.match(/^\s*(\.|#|:|\[|\*|&|>|~|\+|\/)/i) || (W.string.match(/^\s*[a-z]/i) && U(Le(W)))
                                ? ke(se, W, 'block')
                ...
                (de.extend = function ($, W, se) {
                    return $ == '[' || $ == '=' ? 'extend' : $ == ']' ? Je(se) : $ == 'word' ? ((ge = te(W.current())), 'extend') : Je(se);
                }),
    ...
    (function (o) {
        ...
        o.defineMode('coffeescript', function (p, v) {
            ...
            function R(F, D) {
                ...
                if (F.match(/^-?[0-9\.]/, !1)) {
                    var _ = !1;
                    if ((F.match(/^-?\d*\.\d+(e[\+\-]?\d+)?/i) && (_ = !0), F.match(/^-?\d+\.\d*/) && (_ = !0), F.match(/^-?\.\d+/) && (_ = !0), _))
                ...
                if (F.match(E)) {
                    if (F.current() != '/' || F.match(/^.*\//, !1)) return (D.tokenize = M(F.current(), !0, 'string-2')), D.tokenize(F, D);
                    F.backUp(1);
                }
            ...
            function Z(F, D, Q) {
                ...
                Q !== 'coffee' ? ((V = null), (_ = F.column() + F.current().length)) : D.scope.align && (D.scope.align = !1),
            ...
            function re(F, D) {
                var Q = D.tokenize(F, D),
                    j = F.current();
                j === 'return' && (D.dedent = !0), (((j === '->' || j === '=>') && F.eol()) || Q === 'indent') && Z(F, D);
                var V = '[({'.indexOf(j);
                if ((V !== -1 && Z(F, D, '])}'.slice(V, V + 1)), x.exec(j) && Z(F, D), j == 'then' && ee(F, D), Q === 'dedent' && ee(F, D))) return C;
                if (((V = '])}'.indexOf(j)), V !== -1)) {
                    for (; D.scope.type == 'coffee' && D.scope.prev; ) D.scope = D.scope.prev;
                    D.scope.type == j && (D.scope = D.scope.prev);
                }
                return D.dedent && F.eol() && (D.scope.type == 'coffee' && D.scope.prev && (D.scope = D.scope.prev), (D.dedent = !1)), Q;
            }
            var N = {
                startState: function (F) {
                    return { tokenize: R, scope: { offset: F || 0, type: 'coffee', prev: null, align: !1 }, prop: !1, dedent: 0 };
                },
                token: function (F, D) {
                    var Q = D.scope.align === null && D.scope;
                    Q && F.sol() && (Q.align = !1);
                    var j = re(F, D);
                    return j && j != 'comment' && (Q && (Q.align = !0), (D.prop = j == 'punctuation' && F.current() == '.')), j;
                },
                indent: function (F, D) {
            ...
            function (p) {
                ...
                g.prototype.copy = function () {
                    ...
                    return (
                        ...
                        this.innerMode && this.innerState && (U.innerState = o.copyState(this.innerMode, this.innerState)),
                ...
                function T(U, G) {
                    if ((U.sol() && ((G.javaScriptLine = !1), (G.javaScriptLineExcludesColon = !1)), G.javaScriptLine)) {
                ...
                function x(U, G) {
                    if (G.javaScriptArguments) {
                        ...
                        if (
                            (U.peek() === '(' ? G.javaScriptArgumentsDepth++ : U.peek() === ')' && G.javaScriptArgumentsDepth--,
                ...
                function E(U, G) {
                    if (G.isInterpolating) {
                        if (U.peek() === '}') {
                            if ((G.interpolationNesting--, G.interpolationNesting < 0)) return U.next(), (G.isInterpolating = !1), 'punctuation';
                ...
                function N(U, G) {
                    if (U.match(/^include:([a-zA-Z0-9\-]+)/, !1) && U.match('include')) return (G.isIncludeFiltered = !0), v;
                }
                function F(U, G) {
                ...
                function Q(U, G) {
                    if (U.match(/^\+([-\w]+)/))
                        return U.match(/^\( *[-\w]+ *=/, !1) || ((G.javaScriptArguments = !0), (G.javaScriptArgumentsDepth = 0)), 'variable';
                ...
                function j(U, G) {
                    if (G.mixinCallAfter)
                        return (
                            (G.mixinCallAfter = !1),
                            U.match(/^\( *[-\w]+ *=/, !1) || ((G.javaScriptArguments = !0), (G.javaScriptArgumentsDepth = 0)),
                            !0
                        );
                }
                function V(U, G) {
                ...
                function I(U, G) {
                    var ce;
                    if ((ce = U.match(/^(\w(?:[-:\w]*\w)?)\/?/)))
                        return (G.lastTag = ce[1].toLowerCase()), G.lastTag === 'script' && (G.scriptType = 'application/javascript'), 'tag';
                }
                function B(U, G) {
                    if (U.match(/^:([\w\-]+)/)) {
                        var ce;
                ...
                function de(U, G) {
                    if (G.isAttrs) {
                        if ((s[U.peek()] && G.attrsNest.push(s[U.peek()]), G.attrsNest[G.attrsNest.length - 1] === U.peek())) G.attrsNest.pop();
                ...
                function ze(U, G) {
                    if (U.match(/^&attributes\b/)) return (G.javaScriptArguments = !0), (G.javaScriptArgumentsDepth = 0), 'keyword';
                }
                function pe(U) {
                ...
                function Oe(U, G) {
                    if (U.match(/^(?:\| ?| )([^\n]+)/)) return 'string';
                    if (U.match(/^(<[^\n]*)/, !1)) return je(U, G, 'htmlmixed'), (G.innerModeForLine = !0), Ze(U, G, !0);
                }
                function qe(U, G) {
                    if (U.eat('.')) {
                        var ce = null;
                ...
                function Ze(U, G, ce) {
                    if (U.indentation() > G.indentOf || (G.innerModeForLine && !U.sol()) || ce)
                        return G.innerMode
                            ? (G.innerState || (G.innerState = G.innerMode.startState ? o.startState(G.innerMode, U.indentation()) : {}),
                              U.hideFirstChars(G.indentOf + 2, function () {
                                  return G.innerMode.token(U, G.innerState) || !0;
                              }))
                            : (U.skipToEnd(), G.indentToken);
                    U.sol() && ((G.indentOf = 1 / 0), (G.indentToken = null), (G.innerMode = null), (G.innerState = null));
                }
                function ke(U, G) {
                ...
                token: function (b, S) {
                    if (S.innerActive) {
                        ...
                        if (x == b.pos && !E.parseDelimiters)
                            return b.match(E.close), (S.innerActive = S.inner = null), E.delimStyle && E.delimStyle + ' ' + E.delimStyle + '-close';
                        ...
                        for (var s = 1 / 0, h = b.string, g = 0; g < v.length; ++g) {
                            var T = v[g],
                                x = C(h, T.open, b.pos);
                            if (x == b.pos) {
                                T.parseDelimiters || b.match(T.open), (S.startingInner = !!T.parseDelimiters), (S.innerActive = T);
                                var c = 0;
                                if (p.indent) {
                                    var d = p.indent(S.outer, '', '');
                                    d !== o.Pass && (c = d);
                                }
                                return (S.inner = o.startState(T.mode, c)), T.delimStyle && T.delimStyle + ' ' + T.delimStyle + '-open';
                            } else x != -1 && x < s && (s = x);
                        }
    ...
    (function (o) {
        ...
        o.defineSimpleMode('handlebars-tags', {
            ...
            o.defineMode('handlebars', function (p, v) {
                ...
                return !v || !v.base ? C : o.multiplexingMode(o.getMode(p, v.base), { open: '{{', close: /\}\}\}?/, mode: C, parseDelimiters: !0 });
            }),
        ...
        o.defineMode('yaml', function () {
            ...
            return {
                token: function (C, b) {
                    var S = C.peek(),
                        s = b.escaped;
                    if (((b.escaped = !1), S == '#' && (C.pos == 0 || /\s/.test(C.string.charAt(C.pos - 1))))) return C.skipToEnd(), 'comment';
                    if (C.match(/^('([^']|\\.)*'?|"([^"]|\\.)*"?)/)) return 'string';
                    if (b.literal && C.indentation() > b.keyCol) return C.skipToEnd(), 'string';
                    if ((b.literal && (b.literal = !1), C.sol())) {
                        if (((b.keyCol = 0), (b.pair = !1), (b.pairStart = !1), C.match('---') || C.match('...'))) return 'def';
                        if (C.match(/\s*-\s+/)) return 'meta';
                    }
                    if (C.match(/^(\{|\}|\[|\])/))
                        return S == '{' ? b.inlinePairs++ : S == '}' ? b.inlinePairs-- : S == '[' ? b.inlineList++ : b.inlineList--, 'meta';
                    if (b.inlineList > 0 && !s && S == ',') return C.next(), 'meta';
                    if (b.inlinePairs > 0 && !s && S == ',') return (b.keyCol = 0), (b.pair = !1), (b.pairStart = !1), C.next(), 'meta';
                    if (b.pairStart) {
                        if (C.match(/^\s*(\||\>)\s*/)) return (b.literal = !0), 'meta';
                        if (C.match(/^\s*(\&|\*)[a-z0-9\._-]+\b/i)) return 'variable-2';
                        if ((b.inlinePairs == 0 && C.match(/^\s*-?[0-9\.\,]+\s?$/)) || (b.inlinePairs > 0 && C.match(/^\s*-?[0-9\.\,]+\s?(?=(,|}))/)))
                            return 'number';
                        if (C.match(v)) return 'keyword';
                    }
                    return !b.pair && C.match(/^\s*(?:[,\[\]{}&*!|>'"%@`][^\s'":]|[^\s,\[\]{}#&*!|>'"%@`])[^#:]*(?=:($|\s))/)
...
function Id(o) {
    for (var p = new DOMParser(), v = p.parseFromString(o, 'text/html'), C = v.getElementsByTagName('li'), b = 0; b < C.length; b++)
        for (var S = C[b], s = 0; s < S.children.length; s++) {
            var h = S.children[s];
            h instanceof HTMLInputElement && h.type === 'checkbox' && ((S.style.marginLeft = '-1.5em'), (S.style.listStyleType = 'none'));
        }
...
function qi(o, p, v, C, b, S) {
    ...
    if (o.attributes) for (var h in o.attributes) Object.prototype.hasOwnProperty.call(o.attributes, h) && s.setAttribute(h, o.attributes[h]);
    (s.className = o.name),
    ...
    for (var C = v.type.split(' '), b = {}, S, s, h = 0; h < C.length; h++)
        (S = C[h]),
            S === 'strong'
                ? (b.bold = !0)
                : S === 'variable-2'
                  ? ((s = o.getLine(p.line)), /^\s*\d+\.\s/.test(s) ? (b['ordered-list'] = !0) : (b['unordered-list'] = !0))
                  : S === 'atom'
                    ? (b.quote = !0)
                    : S === 'em'
                      ? (b.italic = !0)
...
function jr(o) {
    ...
    if (C.classList.contains('editor-preview-active-side'))
        if (o.options.sideBySideFullscreen === !1) {
            var b = v.parentNode;
            p.getOption('fullScreen') ? b.classList.remove('sided--no-fullscreen') : b.classList.add('sided--no-fullscreen');
        } else bn(o);
    if (
...
function Pi(o) {
    ...
    function v(K) {
        if (typeof K != 'object') throw "fencing_line() takes a 'line' object (not a line number, or line text).  Got: " + typeof K + ': ' + K;
...
`),
            ...
            var N = h.line;
            if (
                (v(s.getLineHandle(h.line)) && (b(s, h.line + 1) === 'fenced' ? ((d = h.line), (N = h.line + 1)) : ((w = h.line), (N = h.line - 1))),
                d === void 0)
            )
                for (d = N; d >= 0 && ((x = s.getLineHandle(d)), !v(x)); d--);
            if (w === void 0) for (E = s.lineCount(), w = N; w < E && ((x = s.getLineHandle(w)), !v(x)); w++);
            s.operation(function () {
                s.replaceRange('', { line: d, ch: 0 }, { line: d + 1, ch: 0 }), s.replaceRange('', { line: w - 1, ch: 0 }, { line: w, ch: 0 });
            }),
                s.focus();
        }
    else if (c === 'indented') {
...
function Ui(o) {
    var p = o.codemirror,
        v = '*';
    ['-', '+', '*'].includes(o.options.unorderedListStyle) && (v = o.options.unorderedListStyle), la(p, 'unordered-list', v);
}
function $i(o) {
...
function yc(o, p) {
    var v = o.codemirror,
        ...
        s = S.substring(S.lastIndexOf('.') + 1)
            .replace(/\?.*$/, '')
            .toLowerCase();
    if (['png', 'jpg', 'jpeg', 'gif', 'svg', 'apng', 'avif', 'webp'].includes(s)) Rr(v, C.image, b.insertTexts.uploadedImage, p);
    else {
...
function bn(o) {
    ...
    C.classList.contains('editor-preview-active-side')
        ...
        : (setTimeout(function () {
              p.getOption('fullScreen') || (o.options.sideBySideFullscreen === !1 ? s.classList.add('sided--no-fullscreen') : jr(o)),
...
function Ji(o) {
    ...
    if ((s.classList.contains('editor-preview-active-side') && bn(o), !S || !S.classList.contains('editor-preview-full'))) {
    ...
    S.classList.contains('editor-preview-active')
        ? (S.classList.remove('editor-preview-active'), b && (b.classList.remove('active'), C.classList.remove('disabled-for-preview')))
        : (setTimeout(function () {
...
function Rr(o, p, v, C) {
    if (!o.getWrapperElement().lastChild.classList.contains('editor-preview-active')) {
        ...
        Object.assign(h, o.getCursor('start')),
            ...
            p
                ? ((b = o.getLine(h.line)), (S = b.slice(0, h.ch)), (s = b.slice(h.ch)), o.replaceRange(S + s, { line: h.line, ch: 0 }))
                : ((b = o.getSelection()), o.replaceSelection(S + b + s), (h.ch += S.length), h !== g && (g.ch += S.length)),
            o.setSelection(h, g),
            o.focus();
    }
}
...
function la(o, p, v) {
    if (!o.getWrapperElement().lastChild.classList.contains('editor-preview-active')) {
        for (
            ...
            (function (E) {
                var z = o.getLine(E);
                S[p] ? (z = z.replace(g[p], '$1')) : (p == 'unordered-list' && (z = c('ordered-list', z, !0)), (z = c(p, z, !1)), (d += 1)),
            ...
            ? ((s = b.getLine(T.line)),
              ...
              p == 'bold'
                  ...
                  : p == 'italic'
                    ...
                    : p == 'strikethrough' && ((h = h.replace(/(\*\*|~~)(?![\s\S]*(\*\*|~~))/, '')), (g = g.replace(/(\*\*|~~)/, ''))),
              b.replaceRange(h + g, { line: T.line, ch: 0 }, { line: T.line, ch: 99999999999999 }),
              p == 'bold' || p == 'strikethrough' ? ((T.ch -= 2), T !== x && (x.ch -= 2)) : p == 'italic' && ((T.ch -= 1), T !== x && (x.ch -= 1)))
            : ((s = b.getSelection()),
              p == 'bold'
...
function gc(o) {
    var p = /[a-zA-Z0-9_\u00A0-\u02AF\u0392-\u03c9\u0410-\u04F9]+|[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af]+/g,
        v = o.match(p),
        C = 0;
    if (v === null) return C;
    ...
    if (o.toolbar === void 0) {
        ...
        for (var S in Pr)
            Object.prototype.hasOwnProperty.call(Pr, S) &&
                ...
                (Pr[S].default === !0 || (o.showIcons && o.showIcons.constructor === Array && o.showIcons.indexOf(S) != -1)) && o.toolbar.push(S));
    }
    if (
        ...
        o.autosave != null && o.autosave.unique_id != null && o.autosave.unique_id != '' && (o.autosave.uniqueId = o.autosave.unique_id),
        o.overlayMode && o.overlayMode.combine === void 0 && (o.overlayMode.combine = !0),
        (this.options = o),
        this.render(),
        o.initialValue && (!this.options.autosave || this.options.autosave.foundSavedValue !== !0) && this.value(o.initialValue),
        o.uploadImage)
    ) {
        var s = this;
        this.codemirror.on('dragenter', function (h, g) {
            s.updateStatusBar('upload-image', s.options.imageTexts.sbOnDragEnter), g.stopPropagation(), g.preventDefault();
        }),
    ...
    wc = Cd(() => {
        ...
        (et = {
            ...
            (Pr = {
                ...
                strikethrough: { name: 'strikethrough', action: Oi, className: et.strikethrough, title: 'Strikethrough' },
                heading: { name: 'heading', action: Jn, className: et.heading, title: 'Heading', default: !0 },
                'heading-smaller': { name: 'heading-smaller', action: Jn, className: et['heading-smaller'], title: 'Smaller Heading' },
                'heading-bigger': { name: 'heading-bigger', action: Ri, className: et['heading-bigger'], title: 'Bigger Heading' },
                ...
                'unordered-list': { name: 'unordered-list', action: Ui, className: et['unordered-list'], title: 'Generic List', default: !0 },
                'ordered-list': { name: 'ordered-list', action: $i, className: et['ordered-list'], title: 'Numbered List', default: !0 },
                ...
                'upload-image': { name: 'upload-image', action: aa, className: et['upload-image'], title: 'Import an image' },
                table: { name: 'table', action: Xi, className: et.table, title: 'Insert Table' },
                'horizontal-rule': { name: 'horizontal-rule', action: Yi, className: et['horizontal-rule'], title: 'Insert Horizontal Line' },
                'separator-3': { name: 'separator-3' },
                preview: { name: 'preview', action: Ji, className: et.preview, noDisable: !0, title: 'Toggle Preview', default: !0 },
                'side-by-side': {
                    name: 'side-by-side',
                    action: bn,
...
Maximum file size is #image_max_size#.`,
        ...
        Te.prototype.uploadImagesUsingCustomFunction = function (o, p) {
            if (p.length !== 0) {
                for (var v = [], C = 0; C < p.length; C++) v.push(p[C].name), this.uploadImageUsingCustomFunction(o, p[C]);
            ...
            if (marked) {
                ...
                if (
                    ...
                    this.options && this.options.renderingConfig && this.options.renderingConfig.singleLineBreaks === !1
                        ? (p.breaks = !1)
                        : (p.breaks = !0),
                    this.options && this.options.renderingConfig && this.options.renderingConfig.codeSyntaxHighlighting === !0)
                ) {
        ...
        Te.prototype.render = function (o) {
            if ((o || (o = this.element || document.getElementsByTagName('textarea')[0]), this._rendered && this._rendered === o)) return;
            this.element = o;
            var p = this.options,
                v = this,
                C = {};
            ...
            function w(y, R) {
                y.setAttribute('data-img-src', R.url),
                    y.setAttribute(
                        'style',
                        '--bg-image:url(' + R.url + ');--width:' + R.naturalWidth + 'px;--height:' + c(R.naturalWidth, R.naturalHeight),
                    ),
                        ...
                        if (R.innerText.match(/^!\[.*?\]\(.*\)/g) && !R.hasAttribute('data-img-src')) {
                            ...
                            if ((window.EMDEimagesCache || (window.EMDEimagesCache = {}), M && M.length >= 2)) {
                                ...
                                if (window.EMDEimagesCache[H]) w(R, window.EMDEimagesCache[H]);
                                    ...
                                    (ee.onload = function () {
                                        (window.EMDEimagesCache[H] = { naturalWidth: ee.naturalWidth, naturalHeight: ee.naturalHeight, url: H }),
        ...
        Te.prototype.uploadImage = function (o, p, v) {
            ...
            var s = new FormData();
            s.append('image', o),
                C.options.imageCSRFToken && !C.options.imageCSRFHeader && s.append(C.options.imageCSRFName, C.options.imageCSRFToken);
            var h = new XMLHttpRequest();
            (h.upload.onprogress = function (g) {
                if (g.lengthComputable) {
                    var T = '' + Math.round((g.loaded * 100) / g.total);
                    C.updateStatusBar('upload-image', C.options.imageTexts.sbProgress.replace('#file_name#', o.name).replace('#progress#', T));
                }
            }),
                h.open('POST', this.options.imageUploadEndpoint),
                C.options.imageCSRFToken && C.options.imageCSRFHeader && h.setRequestHeader(C.options.imageCSRFName, C.options.imageCSRFToken),
                (h.onload = function () {
                    try {
                        var g = JSON.parse(this.responseText);
                    } catch {
                        console.error('EasyMDE: The server did not return a valid json.'), b(S(C.options.errorMessages.importError));
                        return;
                    }
                    this.status === 200 && g && !g.error && g.data && g.data.filePath
                        ...
                        : g.error && g.error in C.options.errorMessages
                          ...
                          : g.error
                            ? b(S(g.error))
                            : (console.error(
                                  'EasyMDE: Received an unexpected response after uploading the image.' + this.status + ' (' + this.statusText + ')',
                              ),
                              b(S(C.options.errorMessages.importError)));
                }),
                (h.onerror = function (g) {
                    console.error(
                        'EasyMDE: An unexpected error occurred when trying to upload the image.' + g.target.status + ' (' + g.target.statusText + ')',
                    ),
            ...
            if (!v || !v.classList.contains('editor-preview-side')) {
                if (((v = document.createElement('div')), (v.className = 'editor-preview-side'), this.options.previewClass))
                    if (Array.isArray(this.options.previewClass))
                        for (var C = 0; C < this.options.previewClass.length; C++) v.classList.add(this.options.previewClass[C]);
            ...
            if (((o = o || this.options.toolbar), !(!o || o.length === 0))) {
                    ...
                    if (
                        ...
                        if (o[p] === '|') {
                            for (var S = !1, s = p + 1; s < o.length; s++)
                                o[s] !== '|' && (!C.options.hideIcons || C.options.hideIcons.indexOf(o[s].name) == -1) && (S = !0);
                            if (!S) continue;
                        }
                        (function (T) {
                            var x;
                ...
                h.on('cursorActivity', function () {
                    ...
                    for (var x in b)
                        (function (c) {
                            var d = b[c];
                            T[c] ? d.classList.add('active') : c != 'fullscreen' && c != 'side-by-side' && d.classList.remove('active');
                        })(x);
                });
                var g = h.getWrapperElement();
            ...
            if (!(!o || o.length === 0)) {
                ...
                for (b = 0; b < o.length; b++)
                    if (((S = void 0), (s = void 0), (h = void 0), typeof o[b] == 'object'))
                        C.push({ className: o[b].className, defaultValue: o[b].defaultValue, onUpdate: o[b].onUpdate, onActivity: o[b].onActivity });
                    else {
                        var g = o[b];
                        g === 'words'
                            ? ((h = function (w) {
                            ...
                            : g === 'lines'
                              ...
                              : g === 'cursor'
                                ...
                                : g === 'autosave'
                                  ? (h = function (w) {
                                        p.autosave != null && p.autosave.enabled === !0 && w.setAttribute('id', 'autosaved');
                                    })
                                  : g === 'upload-image' &&
                                    (h = function (w) {
    ...
    return {
        ...
        init: async function () {
            this.$root._editor && (this.$root._editor.toTextArea(), (this.$root._editor = null)),
                    ...
                    try {
                        ...
                        if (E.origin === '+input') {
                            ...
                            if (y.endsWith(z) && y !== '[]' + z) {
                                ...
                                setTimeout(() => {
                                    d.setSelection({ line: M.line, ch: Z + y.lastIndexOf('(') + 1 }, { line: M.line, ch: Z + y.lastIndexOf(')') });
                                }, 25);
                            }
                        }
                    } catch {}
                ...
                this.$watch('state', () => {
                    this.editor && (this.editor.codemirror.hasFocus() || Alpine.raw(this.editor).value(this.state ?? ''));
                }),
                h && h(this);
        },
        destroy: function () {
        ...
        getToolbar: function () {
            let d = [];
            return (
                x.includes('bold') && d.push({ name: 'bold', action: EasyMDE.toggleBold, title: T.toolbar_buttons?.bold }),
                x.includes('italic') && d.push({ name: 'italic', action: EasyMDE.toggleItalic, title: T.toolbar_buttons?.italic }),
                x.includes('strike') && d.push({ name: 'strikethrough', action: EasyMDE.toggleStrikethrough, title: T.toolbar_buttons?.strike }),
                x.includes('link') && d.push({ name: 'link', action: EasyMDE.drawLink, title: T.toolbar_buttons?.link }),
                ['bold', 'italic', 'strike', 'link'].some((w) => x.includes(w)) && ['heading'].some((w) => x.includes(w)) && d.push('|'),
                x.includes('heading') && d.push({ name: 'heading', action: EasyMDE.toggleHeadingSmaller, title: T.toolbar_buttons?.heading }),
                ['heading'].some((w) => x.includes(w)) &&
                    ['blockquote', 'codeBlock', 'bulletList', 'orderedList'].some((w) => x.includes(w)) &&
                    d.push('|'),
                x.includes('blockquote') && d.push({ name: 'quote', action: EasyMDE.toggleBlockquote, title: T.toolbar_buttons?.blockquote }),
                x.includes('codeBlock') && d.push({ name: 'code', action: EasyMDE.toggleCodeBlock, title: T.toolbar_buttons?.code_block }),
                x.includes('bulletList') &&
                    d.push({ name: 'unordered-list', action: EasyMDE.toggleUnorderedList, title: T.toolbar_buttons?.bullet_list }),
                x.includes('orderedList') &&
                    d.push({ name: 'ordered-list', action: EasyMDE.toggleOrderedList, title: T.toolbar_buttons?.ordered_list }),
                ['blockquote', 'codeBlock', 'bulletList', 'orderedList'].some((w) => x.includes(w)) &&
                    ['table', 'attachFiles'].some((w) => x.includes(w)) &&
                    d.push('|'),
                x.includes('table') && d.push({ name: 'table', action: EasyMDE.drawTable, title: T.toolbar_buttons?.table }),
                x.includes('attachFiles') &&
                    d.push({ name: 'upload-image', action: EasyMDE.drawUploadedImage, title: T.toolbar_buttons?.attach_files }),
                ['table', 'attachFiles'].some((w) => x.includes(w)) && ['undo', 'redo'].some((w) => x.includes(w)) && d.push('|'),
